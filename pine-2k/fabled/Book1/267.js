save("save/bookmark", "Book1/267.js");
...
`
  ...
  You row out into the lake, spread
the net, and wait to see what
happens.

  After an hour or so, a great
bubbling and frothing of the lake
disturbs your solitude. A massive
scaly head, the size of your boat,
erupts out of the ochre-coloured
water on the end of a long,
sinuous neck. Great luminous green
eyes look down at you. The
creature is covered in brown
scales, with a bright red crest
running from the head down its
thick, ropy neck.

  'I am Vayss the Sea Dragon,' it`,
MARK,
`says in a rich, creamy voice,
tinged with evil greed. 'To fish
in my lake, you have to pay
tribute - to wit, one silver
nugget. Pay now, or face my
wrath.'
  `,
GOTO,
"Book1/505.js",
`Hand over a silver nugget`,
`
  `,
GOTO,
"Book1/582.js",
`Unable or refuse to pay`,
MARK
];
