save("save/bookmark", "Book1/664temp.js");
...
says the soldier. Several archers
stand up from their hiding places
behind the rocks overhead.

  Another soldier, a captain, comes
up to you and introduces himself
as Captain Vorkung.

  He is clearly one of the old
aristocracy, the nobles loyal to
the king and the old regime,
before General Marlock and the
army seized power, and executed
the old king. Vorkung tells you to
leave the mountains.

  You have found a rebel base - men`,
MARK,
`still loyal to Nergan Corin, the
heir to the throne. Nergan went
into hiding when General Marlock
killed his father and took control
of Sokara.

  You can attempt to convince
Captain Vorkung that you are on
his side by`,
GOTO,
"Book1/extra_254.js",
`making a CHARISMA roll
at Difficulty 9`,
`. You can add 1 to
your roll if you are a Warrior,
Rogue, or Wayfarer. If you
succeed, . If you fail, .
Otherwise, you can climb down the
mountains,`,
GOTO,
"Book1/474.js",
`go to 474`,
