save("save/bookmark", "Book1/260.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are shocked to find that you
cannot damage the tomb guardian at
all! You have no choice but to run
for the door. Roll one die - if
the result is less than or equal
to your Rank, you make it back out
into the Forest - . Otherwise, the
whirlwind guardian catches you,
and buffets you against the stone
walls until you are dead - your
adventures are over unless you
