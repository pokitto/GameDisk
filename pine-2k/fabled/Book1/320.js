save("save/bookmark", "Book1/320.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You learn from their conversations
that they are from the jungles of
distant Ankon-Konu, the Feathered
Lands, and that they have come
here to find new sacrifices for
their god, and new members for
their cult. The chef pronounces
the cauldron is ready, and they
remove the net that holds you.
  `,
GOTO,
"Book1/204.js",
`Fight`,
