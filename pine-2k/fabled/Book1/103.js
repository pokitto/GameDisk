save("save/bookmark", "Book1/103.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You set sail for Copper Island. The
uneventful journey takes only a
few days. The captain cannot
believe how smooth the voyage has
been. You disembark at the harbour
of Copper Island.`,
GOTO,
"Book3/99.js",
`Turn to
paragraph 99 in Over the
Blood-Dark Sea`,
`.`,
MARK
];
