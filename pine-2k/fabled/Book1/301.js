save("save/bookmark", "Book1/301.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` A barque, heading for the Isle of
Druids to buy furs, is prepared to
take you. Cross off 15 Shards .
The journey, across the Sea of
Whispers, is uneventful, and you
dock at the Trading Post on the
island a week or so later.`,
GOTO,
"Book1/195.js",
`go to
195`,
