save("save/bookmark", "Book1/411.js");
...
the * golden net * of the twin
gods has been stolen. The
repulsive ones have taken it to
their palace beneath the sea in
the Sunken City of Ziusudra. The
repulsive ones worship the
fish-god Oannes, who struggles
with Alvir and Valmir for control
of the sea.

  'We must have that * golden net *
, or the repulsive ones will use
it against us. If you return it to
us, we will reward you,' says the
high priest. 'The Sunken City lies
under the coastal waters off the
Shadar Tor.'`,
MARK,
`
  If you take the mission, gain the
codeword Anchor . When you are
finished, turn to * 220 * .`,
MARK
];
