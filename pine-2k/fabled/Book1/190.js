save("save/bookmark", "Book1/190.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are sailing along the coast off
Blessed Springs and Fort Brilon.
Gulls cluster around the ship,
looking for food. Their cries echo
