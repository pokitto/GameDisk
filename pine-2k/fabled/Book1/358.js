save("save/bookmark", "Book1/358.js");
...
Trees,' says a passing woman,
dressed in the garb of a druid.

  The city has been built amid the
branches of several mighty oaks.
Ladders run up and down the trees
to houses that perch like nests in
the branches. You are not allowed
into any houses, but the druids
allow you to barter at the market.

  Items with no purchase price are
not available locally.

  When you are finished, if you are
a Wayfarer by profession,`,
GOTO,
"Book1/645.js",
`go to
645`,
`. Otherwise you leave the City`,
MARK,
`of Trees.`,
GOTO,
"Book1/678.js",
