save("save/bookmark", "Book1/662.js");
...
`
  ...
  That night, after Lauria has
picked the locks on your chains,
you head off for the tunnel
rendezvous. You find there has
been a cave-in, but the overseer
and a troop of guards are waiting
for you!

  Lauria steps out laughing. In
return for her betraying you, the
overseer has transferred her to
work on the surface, from which
she will be able to escape more
easily. You have been stitched up
again!

  The overseer has you whipped for
trying to escape and you are left`,
MARK,
`with some nasty scars. Lose 1
point of CHARISMA permanently .

  Gain the codeword Anger , and
lose the codeword Ashen .

  A few days later, you try another
escape on your own.`,
GOTO,
"Book1/565.js",
`go to 565`,
