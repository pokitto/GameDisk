save("save/bookmark", "Book1/615.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Lacuna is the Goddess of the Moon,
and of the Wilderness. She aids
hunters, and woodsmen, and
travellers in the lost places of
the world. Her temple here is a
long hall of oak, covered in vines
and plants of all kinds. Inside,
flowers fill the air with a pure
and clean scent.
  `,
GOTO,
"Book1/170.js",
