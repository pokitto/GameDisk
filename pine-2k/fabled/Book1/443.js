save("save/bookmark", "Book1/443.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are witness to a major sea
battle, involving at least 40
warships, between the Sokaran
navy, and a pirate fleet. Arrows
fill the air, and smoking
fireballs are launched from
catapults mounted on some of the
ships. The shrieks of the dying
carry across the waves. You decide
