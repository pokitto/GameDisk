save("save/bookmark", "Book1/200.js");
...
`
  ...
  You have acquired an old map of
the Forest of the Forsaken in
Golnir (in _ Cities of Gold and
Glory _ ), showing a safe path
that leads to the Tower of
Despair. It seems to conflict with
the location of the Tower on your
own map. Which is correct?

  You can turn to * 200 * in _ The
War-Torn Kingdom _ whenever you
wish, providing you own the map,
but remember, always note the
paragraph you were at before
turning here.

  Return to the paragraph you came
from (if you have only just bought`,
MARK,
`the map, you were in Yellowport
market, so return to * 30 * ).`,
MARK
];
