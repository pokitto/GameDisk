save("save/bookmark", "Book1/276.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are wandering across the
wilderness of north-western
Sokara. There is a magnificent
castle nearby, with many different
pennants flying from its towers.
  `,
GOTO,
"Book1/611.js",
`Visit the castle`,
...
GOTO,
"Book1/110.js",
`Head east into the Bronze Hills`,
`
  `,
GOTO,
"Book1/47.js",
`Go south into the Forest of
Larun`,
MARK
];
