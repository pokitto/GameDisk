save("save/bookmark", "Book1/289.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` There is a pause, as if you are
both waiting for something to
happen. You realize the gods have
not heard your prayer, as does
your enemy. It snarls
triumphantly, and slashes you
across the chest. Lose 2 Stamina .
If you still live, you have no
