save("save/bookmark", "Book1/135.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The shores of the Lake of the Sea
Dragon are swept by ochre waves,
and the air smells foul. A sickly,
pale green seaweed is the only
vegetation that can survive in the
sulphurous waters of the lake. A
small fishing village, Cadmium,
has grown up on the shores of the
lake.
  `,
GOTO,
"Book1/382.js",
...
GOTO,
"Book1/474.js",
`Go north to the Coldbleak
Mountains`,
`
  `,
GOTO,
"Book1/548.js",
`North east into the farmlands`,
`
  `,
GOTO,
"Book1/278.js",
`South east into open countryside`,
`
  `,
GOTO,
"Book1/576.js",
`South, following the Stinking
River`,
`
  `,
GOTO,
