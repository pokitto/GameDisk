save("save/bookmark", "Book1/490.js");
...
`
  ...
  When you hit the guardian, you
tear away great wispy chunks of
its smoky essence. Eventually, it
dissolves into nothingness.

  Inside the sarcophagus you find
the mouldering bones of a
long-dead wizard. In his skeletal
hands you find the Book of
Excellence. As you scan the pages,
you learn all sorts of new tricks
- add one to the ability of your
choice (such as SCOUTING or
COMBAT) permanently. Once you have
read it, the book disappears with
a flash.

  You thread your way out of the`,
MARK,
`Tomb of the Wizard King, back into
the Forest of Larun.`,
GOTO,
"Book1/47.js",
`go to 47`,
