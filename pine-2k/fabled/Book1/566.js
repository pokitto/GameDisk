save("save/bookmark", "Book1/566.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are discovered hiding in the
kitchen pantry. You are hauled off
and thrown into the dungeons to
await judgement - lose all your
