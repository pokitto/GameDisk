save("save/bookmark", "Book1/589.js");
...
`
  ...
  Striding purposefully into the
tavern, you walk straight up to
him and say, 'I want what you've
got under that eyepatch.'

  His one good eye widens in
surprise, and he jumps back,
drawing his sword.

  'We'll see about that, by Sig!'
he cries.

  The other people in the tavern
draw back to give you room and
start taking bets on the outcome
of the fight.
...
`. If you`,
MARK,
`lose, the man with the eyepatch
kills you - your adventuring days
are over, unless you have a
resurrection deal .`,
MARK
];
