save("save/bookmark", "Book1/224.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Using your wilderness-honed sense
of direction you dart through the
maze of tunnels. Soon the sounds
of pursuit fade, until they are
but a dim echo. Heaving a sigh of
relief, you press on.`,
GOTO,
"Book1/580.js",
`go to 580`,
