save("save/bookmark", "Book1/201.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The road between the Citadel and
Caran Baru is chock-a-block with
troops and carts. It looks like
there is a war in the north.
  `,
GOTO,
"Book1/271.js",
`Head for the citadel`,
`
  `,
GOTO,
"Book1/400.js",
`Go south to Caran Baru`,
`
  `,
GOTO,
"Book1/276.js",
