save("save/bookmark", "Book1/412.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are on the cobbled road between
Yellowport and Trefoille. You meet
a few merchants and pilgrims, but
all in all it is an uneventful
journey.
  `,
GOTO,
"Book1/10.js",
