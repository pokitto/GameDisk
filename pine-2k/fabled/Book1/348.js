save("save/bookmark", "Book1/348.js");
...
`
  ...
  You remember what the fishermen
say - the root of a certain
seaweed, when crushed, gives off a
cloud of toxic fluid. This sap is
harmless to humans but is known to
paralyse marine creatures for a
short while. Fortunately, the
seaweed grows in abundance here.
You swim down with a handful of
the roots, squeezing its sap into
the waters. The hideous creatures
shoot towards you, but are
paralysed the instant they enter
the cloud of reddish fluid that
billows around you.

  You take the (note it on your
Adventure Sheet) and swim back to`,
MARK,
`the Shadar Tor as fast as you can.
  `,
GOTO,
"Book1/602.js",
`Take the road to Trefoille`,
`
  `,
GOTO,
"Book1/166.js",
