save("save/bookmark", "Book1/516.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You pull the * wolf pelt * over
you, and drop to all fours.
Gingerly, you crawl in. In the
dark, you now look and smell like
a wolf. At the back of the cave,
you find a hole in the roof and an
iron ladder leading up to it.
  `,
GOTO,
"Book4/350.js",
`Climb the ladder`,
