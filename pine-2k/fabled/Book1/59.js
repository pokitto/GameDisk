save("save/bookmark", "Book1/59.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your deft fingers find a false
spine of carved wood among the
titles in the bookcase. Pressing
it, you hear a click and the
bookcase swings out from the wall.
Beyond lies a hidden room where
you find a . Note this on your
Adventure Sheet if you decide to
take it.
  `,
GOTO,
"Book1/10.js",
