save("save/bookmark", "Book1/597.js");
...
`
  ...
  'You did it!' exclaims the warden
happily, taking the * ghoul's head
* and placing it in a jar. Cross
it off your Adventure Sheet.

  You can have a choice of reward:
an , , or a free`,
GOTO,
"Book1/350.js",
`resurrection deal`,
...
three rewards.
  ...
  To arrange resurrection, write
'Temple of Nagil - _ The War-Torn
Kingdom _ * 350 * )' in the
Resurrection box on your Adventure
Sheet. If you are later killed,
turn to * 350 * in this book.
`,
MARK,
`  Finally, if you are suffering
from ghoulbite disease,`,
GOTO,
"Book1/156.js",
`go to 156`,
`
. Otherwise, you return to town:`,
GOTO,
"Book1/100.js",
`go
to 100`,
