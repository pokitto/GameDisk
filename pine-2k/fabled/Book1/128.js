save("save/bookmark", "Book1/128.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You make your way around the coast.
The interior of the island appears
to be heavily forested. After a
while, however, you come to a bay
in which a couple of ships are
anchored. A small settlement
nestles on the beach, and you make
your way towards it.`,
GOTO,
"Book1/195.js",
`go to 195`,
