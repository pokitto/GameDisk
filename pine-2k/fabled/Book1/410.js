save("save/bookmark", "Book1/410.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` 'Oh, what a load of rotten leaves!'
exclaims the tree. 'Anyone can see
you're as bad as the next human.
In fact, I'd say you're probably
a... a lumberjack! Now, get lost!'
  `,
GOTO,
"Book1/678.js",
`Leave the forest`,
