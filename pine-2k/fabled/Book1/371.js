save("save/bookmark", "Book1/371.js");
...
`
  ...
  With a war cry, you leap to the
attack. Your first blow rips away
a great chunk of its body!

  Suddenly, a voice pipes up from
inside the Gob-gobbler. 'Help,
help, lads, this one's a real
fighter!'

  You realize the Gob-gobbler is a
man disguised as a monster. But
then two thugs - bandits, by the
look of them - run out of the
woods to attack you. You must
