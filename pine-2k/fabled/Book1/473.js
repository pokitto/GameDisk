save("save/bookmark", "Book1/473.js");
...
`
  ...
  The slave market is a large,
canvas-covered square. The poor
unfortunate slaves, people from
all over Harkuna - from the
Feathered Lands, Golnir, criminals
of Sokara, nomads from the
steppes, are paraded in chains on
a dais. Merchants and nobles bid
for the slaves they want. If there
is a tick in the above box,`,
GOTO,
"Book1/610.js",
`go to
610`,
`immediately. If not, and read
on.

  An unusual sale has come up - a
little, furry, bat-winged
humanoid. It is one of the
Mannekyn People from Sky Mountain
in the north and it is going for`,
MARK,
`50 Shards.
...
`go to 459`,
`
. If not, you head back into town.`,
GOTO,
"Book1/400.js",
`
go to 400`,
