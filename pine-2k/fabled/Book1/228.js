save("save/bookmark", "Book1/228.js");
...
`
  ...
  A stone slab at the base of the
idol shifts ominously as you put
your foot on it. A wickedly barbed
spear springs out of the ground,
straight into your leg. .

  If you still live, you remove the
chain mail and sling it over your
shoulder. Note the * gold chain
mail of Tyrnai * on your Adventure
Sheet. Because it is made of gold,
it is useless if worn as armour.

  As you glance at the
jaguar-headed idol, its eyes seem
to turn to look at you.`,
GOTO,
"Book1/extra_69.js",
`Make a
SANCTITY roll at a difficulty of 8`,
`
.`,
MARK
];
