save("save/bookmark", "Book1/284.js");
...
`
  ...
  You find an open window and
squeeze through into a long hall.
Your foot, however, snags on a
thin wire stretched across the
floor. The wire triggers a loud
bell-like gonging that alerts the
temple. You have little choice but
to run for your life - warrior
priests swarm out of the temple
and the iron statues at its gates
come to life to join in the chase.

  Roll a die, and subtract one from
the total . If the result is less
than or equal to your Rank, .
Otherwise, .`,
MARK
];
