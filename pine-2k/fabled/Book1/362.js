save("save/bookmark", "Book1/362.js");
...
`
  ...
  The sea dragon dives deep to the
bottom of the lake. You are pulled
along at a terrific rate through
the murky waters. You think your
lungs are about to burst when at
last the creature surges upwards,
breaking the surface.

  You find yourself in a cave
inside a rocky island, somewhere
on the surface of the lake. A hole
in the roof lets in a shaft of
bright sunlight, that reflects off
the water, casting dappled yellow
light all over the walls.

  Part of the cave is dry ground,
heaped with the dragon's treasure`,
MARK,
`hoard - sparkling coins, swords,
armour, and the like. You notice a
rocky ledge, lined with a number
of bottles, full of yellow dust.

  The dragon pulls itself on top of
its hoard - you have a few seconds
to try to hide.`,
GOTO,
"Book1/extra_122.js",
`Make a THIEVERY
roll at a Difficulty of 10`,
`.`,
MARK
];
