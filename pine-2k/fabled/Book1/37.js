save("save/bookmark", "Book1/37.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your men have been fishing with a
net. This time, however, they have
caught a large shark. Afterwards,
when it has been cut open, you
find the remains of some poor
sailor. Inside his leather pouch,
you find a , which you can take if
you wish.`,
GOTO,
"Book1/507.js",
`go to 507`,
