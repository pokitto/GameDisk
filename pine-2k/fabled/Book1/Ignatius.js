save("save/bookmark", "Book1/Ignatius.js");
...
`
  ...
  Ignatius is a traveller whose
desire is to learn all he can
about the deities of the Fabled
Lands. His strong beliefs give his
sermons added zest, and he has
enthralled many a crowd with his
impassioned speeches. He is
looking for the house of priests
in Marlock City.

  You can play as Ignatius, or as a
priest with a different name
...
const abilities = [4,2,3,6,4,2];
save("save/abilities", abilities);


save("save/name", "Ignatius the Devout");
