save("save/bookmark", "Book1/58.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` He doesn't notice you hiding in the
shadowy doorway of a nearby
derelict house. As he passes, you
step out and attack, taking him
completely by surprise. He goes
down with your first blow.
Searching him, you find , which
you can take if you wish. Then you
flip up his eyepatch. Nestling in
the eye socket is a sparkling gem,
a flame opal. You pluck it free.
Note the on your Adventure Sheet
and delete the codeword _ Barnacle
_ . Quickly, you haul the body
into the shadows and head for the
city centre.`,
GOTO,
"Book1/400.js",
`go to 400`,
