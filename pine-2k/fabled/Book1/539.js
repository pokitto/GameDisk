save("save/bookmark", "Book1/539.js");
...
`
  ...
  You roll across the eaves of the
gate and reach down to pull the
plug on the other golem in one
deft movement. It ceases to
function before it can give the
alarm. It is an easy matter to get
into the temple from the roof.

  Inside, it is cool and dark,
filled with an unearthly
stillness. You reach forward to
strip the armour off the idol of
Tyrnai.

  `,
GOTO,
"Book1/extra_209.js",
`Make a THIEVERY roll at a
difficulty of 12`,
`.`,
MARK
];
