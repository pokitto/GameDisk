save("save/bookmark", "Book1/360.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You have no luck in tracking down
the ghoul. The next day, you hear
a rumour doing the rounds in the
taverns. A ghoul was found and
destroyed by an adventuring
priestess of Tyrnai - apparently,
the temple of Nagil rewarded her
handsomely. Looks like you were
pipped at the post.`,
GOTO,
"Book1/100.js",
`go to 100`,
