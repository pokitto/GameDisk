save("save/bookmark", "Book1/196.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` If you were wounded by the ghoul
you have been infected with a
disease ( ). Note that, until you
can find a cure, you must subtract
one from your SANCTITY, COMBAT and
CHARISMA abilities (no ability can
drop below one). If you were
already suffering from Ghoulbite,
there are no further effects. In
any case, you hack off the hideous
head and leave. Note you have a
and`,
GOTO,
"Book1/100.js",
`go to 100`,
