save("save/bookmark", "Book1/159.js");
...
`
  ...
  Your mind falls into a waking
dream, and you walk lazily into
the waters. The mer-folk, laughing
and singing, take you down to
their undersea home of living
coral, where they stop you from
drowning with their faery magic.
They keep you for several weeks,
until you are no longer an
amusement to them.

  You wake up, as is from a long
sleep, with only a shadowy memory
of your ordeal, to find yourself
washed up in the harbour of
Yellowport. You have lost all the
possessions you were carrying (
erase them from your Adventure`,
MARK,
`Sheet ) but you still have your
money.`,
GOTO,
"Book1/10.js",
`go to 10`,
