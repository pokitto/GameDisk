save("save/bookmark", "Book1/38.js");
...
`
  ...
  Heavy black clouds race towards
you across the sky, whipping the
waves into a frenzy. The crew
mutter among themselves fearfully.
If you have the blessing of Alvir
and Valmir, which confers Safety
from Storms, you can ignore the
storm. Cross off the blessing and`,
GOTO,
"Book1/209.js",
`
go to 209`,
...
galleon. Add one to the roll if
the crew's quality is good; add 2
if it is excellent.`,
GOTO,
"Book1/325.js",
`Ship sinks`,
