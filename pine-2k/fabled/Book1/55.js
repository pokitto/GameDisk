save("save/bookmark", "Book1/55.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You remember that this is a trap
set up by the cannibal cultists of
Badogor. While one pretends to be
hurt, two other skulk in the
shadows, waiting to ambush the
curious. Forewarned you are able
to take them by surprise. You cut
one down in seconds and the figure
on the ground runs off with a
shriek of terror. The third
cultist, however, turns to fight
you. If you win, you find a on his
body.`,
GOTO,
"Book1/10.js",
`go to 10`,
