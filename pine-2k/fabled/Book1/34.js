save("save/bookmark", "Book1/34.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You make it only 50 feet up the
sheer rockface before you lose
your footing and fall to the
ground. Lose 4 Stamina points . If
you still live,`,
GOTO,
"Book1/658.js",
`go to 658`,
