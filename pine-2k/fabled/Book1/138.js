save("save/bookmark", "Book1/138.js");
...
`. If not, read on.
  ...
  You take a stroll through the
streets - Marlock City is teeming
with people.
  `,
GOTO,
"Book1/15.js",
`Explore the Barracks area`,
`
  `,
GOTO,
"Book1/129.js",
`Visit the Street of Entertainers`,
`
  `,
GOTO,
"Book1/619.js",
`Enter the residential quarter`,
MARK
];
