save("save/bookmark", "Book1/287.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You wait for an hour. At dusk,
something emerges. It is the
gorlock, a beast with legs like a
bird, a body like a reptile, with
two short forelimbs and a beaked,
lizard-like head. You see that its
two legs do have backward pointing
feet. The beast heads off into the
hills, and you creep forwards.`,
GOTO,
"Book1/315.js",
`go
to 315`,
