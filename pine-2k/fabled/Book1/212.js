save("save/bookmark", "Book1/212.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are dissolved in the acid,
until all that is left of you is a
pile of yellow dust. Vayss scoops
you up and puts you into a bottle
on his shelf. Cross off _ all _
the possessions and money you were
carrying, and`,
GOTO,
"Book1/31.js",
`go to 31`,
