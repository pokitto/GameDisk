save("save/bookmark", "Book1/317.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` It is the same craft you got the
magic spear from, with the
silver-skinned demon inside -
still dead you presume. You
examine it again, but there is
nothing else of interest on board.
The figure still lies there
unmoving. You sail on.`,
GOTO,
"Book1/85.js",
`go to 85`,
`.`,
