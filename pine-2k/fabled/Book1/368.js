save("save/bookmark", "Book1/368.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Becoming an initiate of Maka gives
you the benefit of paying less for
blessings and other services the
temple can offer. It costs 50
Shards to become an initiate. You
cannot become an initiate of Maka
if you are already an initiate of
another temple. If you choose to
become an initiate, write Maka in
the God box on your Adventure
Sheet - and remember to cross off
the 50 Shards. Once you have
finished here,`,
GOTO,
"Book1/141.js",
`go to 141`,
