save("save/bookmark", "Book1/409.js");
...
`
  ...
  Becoming an initiate of Nagil
gives you the benefit of paying
less for services the temple can
offer. You cannot do this if you
are already an initiate of another
temple. To become an initiate you
have to pass a priestly exam.
...
difficulty of 10`,
`unless there is a
tick in the above box, in which
case it is at`,
GOTO,
"Book1/extra_153.js",
`Difficulty 15`,
