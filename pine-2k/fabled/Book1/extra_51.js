save("save/bookmark", "Book1/extra_51.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` If the score is less than or equal
to your Rank, you manage to find
some driftwood, and make it back
to shore. Lose Stamina points
equal to the score of one dice
roll and, if you can survive that,`,
GOTO,
"Book1/591.js",
`
go to 591`,
