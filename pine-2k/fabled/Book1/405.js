save("save/bookmark", "Book1/405.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The merchants' guild of Yellowport
is a large building of granite,
plushly decorated inside to show
off its wealth. Here you can bank
your money for safe-keeping - or
invest it in guild enterprises in
the hope of making a profit. You
hear that the guildmaster is
looking for adventurers.
  `,
GOTO,
"Book1/122.js",
`Visit the guildmaster`,
`
  `,
GOTO,
"Book1/46.js",
...
GOTO,
"Book1/605.js",
`Deposit or withdraw money (note
that you are in Yellowport)`,
`
  `,
GOTO,
"Book1/10.js",
