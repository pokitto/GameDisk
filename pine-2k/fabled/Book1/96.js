save("save/bookmark", "Book1/96.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` One of the militiamen kicks over a
table, blocking your escape. You
set your back to a corner of the
room and grimly prepare to fight
for your life. Fight them one at a
time: If you win,`,
GOTO,
"Book1/432.js",
`go to 432`,
