save("save/bookmark", "Book1/112.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The merchants' guild is
comparatively small here. Most of
its work involves financial
services for the army. Here you
can bank your money for
safe-keeping, but there are no
facilities for investment. You can
deposit or withdraw money - note
that you are in Caran Baru and`,
GOTO,
"Book1/605.js",
`go
to 605`,
