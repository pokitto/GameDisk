save("save/bookmark", "Book1/459.js");
...
`
  ...
  Cross off 50 Shards . The little
Mannekyn creature is handed over
to you on a leash. Its wings have
been tied together to stop it
flying away.

  'Who are you, then?' it pipes in
a squeaky voice.

  Just then, a palanquin, carried
by four bearers, arrives. A man
leans out and hails you, 'You
there! I've come to buy that
flying monkey but I see I am too
late. Nevertheless, I will give
you 75 Shards for it.'

  'Don't sell me to that popinjay -`,
MARK,
`free me instead,' chitters the
Mannekyn.
  `,
GOTO,
"Book1/659.js",
