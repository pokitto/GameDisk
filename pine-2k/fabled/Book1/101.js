save("save/bookmark", "Book1/101.js");
...
`
  ...
  You yell the name of their god
again and again. The cultists clap
their hands over their ears,
hopping about in horror.

  'Aargh!' howls the leader. 'Stop
your blaspheming, you heathen
devil!'

  In their confusion, you make it
to your equipment. Now you can
fight your way out.`,
GOTO,
"Book1/extra_0.js",
`Make a COMBAT
roll at a difficulty of 13`,
`. If
you fail, . If you succeed, you
manage to fight your way to
freedom with the loss of 4 Stamina
points and head back to town, .`,
MARK
];
