save("save/bookmark", "Book1/402.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your ship draws away, leaving the
Sokarans behind. Your crew jeer at
them, and you spot the captain
shaking his fist at you in rage,
