save("save/bookmark", "Book1/448.js");
...
only 5 Shards to propitiate the
twin gods of the sea. A
non-initiate must pay 20 Shards.
Cross off the money and mark
Safety from Storms in the
Blessings box on your Adventure
Sheet. The blessing works by
allowing you to ignore any one
storm at sea. When you use the
blessing, cross it off your
Adventure Sheet. You can have only
one Safety from Storms blessing at
any one time. Once it is used up,
you can return to any branch of
the temple of Alvir and Valmir to
buy a new one.
`,
MARK,
`  `,
