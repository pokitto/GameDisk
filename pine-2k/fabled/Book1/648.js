save("save/bookmark", "Book1/648.js");
...
`
  ...
  You remain quiet as a mouse,
behind a pile of coins. After a
long wait, the sea dragon slithers
into the water, and swims out on
some errand.

  You have some time to loot the
hoard. You scrabble about for the
chest that Oliphard the Wizardly
wanted you to find for him. You
find a rune-covered box which is
positively glowing with magic.
Note the on your Adventure Sheet.
You can also choose up to three
treasures from the following:
...
`  
  ...
  After you have taken the third
treasure, you hear the sea dragon
returning. Quickly you climb up
through the hole in the roof on to
an island in the middle of the
lake. From there, you manage to`,
MARK,
`get a lift on a passing boat, and
make it safely to Cadmium village.

  During the journey, you examine
the * magic chest * , but it is
guarded by great sorcery and is
impossible to open.
