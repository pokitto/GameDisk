save("save/bookmark", "Book1/670.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You feel a wrenching moment of
disorientation, and then you
suddenly appear with a flash
beside a ruined, burnt-out city. A
passing builder stares at you in
horror, unsure whether you are a
human or a demon. Quickly, you
hurry away.`,
GOTO,
"Book1/250.js",
`go to 250`,
