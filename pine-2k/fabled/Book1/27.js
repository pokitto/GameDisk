save("save/bookmark", "Book1/27.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Either you are recklessly brave, or
very foolish to visit the palace
where you assassinated the
governor, Provost Marshal Royzer
has established new security
procedures, and it is impossible
for you to see him.`,
GOTO,
"Book1/10.js",
`Return to 10`,
