save("save/bookmark", "Book1/501temp.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` If you didn't have enough money in
the bank to cover the ransom
demand,`,
GOTO,
"Book1/288.js",
`go to 288`,
`. Otherwise,
your captors take the money and
run. You are released into
Yellowport,`,
GOTO,
"Book1/10.js",
`go to 10`,
