save("save/bookmark", "Book1/339.js");
...
`
  ...
  You find a burned-out house in
the poor quarter where a trader
has set up a stall, selling ash
and debris. The merchant, a
weaselly-looking old woman, is
screeching, 'Ashes, ashes from the
house of a sorceress! Fifteen
Shards a packet!'

  If you want to buy some, cross
off 15 Shards and note the * ashes
* on your Adventure Sheet. When
you are ready, you head back to
