save("save/bookmark", "Book1/213.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Each creature bursts open in death,
spilling a black empty cloud into
the water. The sac in which this
ink is kept falls free from its
body. You can take the * ink sacs
* if you wish - note up to three
of them on your Adventure Sheet.
You also find coral jewellery
worth about that you can take as
cash. You swim down and take the
(note it on your Adventure Sheet)
and swim for the Shadar Tor as
fast as you can.
  `,
GOTO,
"Book1/602.js",
