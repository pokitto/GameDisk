save("save/bookmark", "Book1/279.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` What you have just done is probably
a sacrilege, desecrating the
Temple of Tyrnai, but you don't
care. You sneak out of the temple
unseen, and head back to town with
your prize. Who else could have
stolen something from right under
the noses of the warrior priests
of Tyrnai!`,
GOTO,
"Book1/400.js",
`go to 400`,
