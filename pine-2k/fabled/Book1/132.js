save("save/bookmark", "Book1/132.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You play the flute like never
before. The king and the queen are
enchanted by the haunting melodies
you are able to coax from the
enchanted flute. Unfortunately,
you have played too well. The king
puts you under a spell, so that
you find you cannot stop.`,
GOTO,
"Book1/extra_26.js",
`Make a
SANCTITY roll at a difficulty of
11`,
`.`,
MARK
];
