save("save/bookmark", "Book1/64.js");
...
trap off, and the chest explodes!
You take the full force of the
blast - lose 5 Stamina points . If
you are still alive, you also find
that the contents of the chest
have been vaporized - except for a
sturdy metal scroll case,
containing a piece of ancient
religious text about the gods of
Uttaku. You discover from the
scroll that one of the gods of the
Uttakin is called Ebron, and that
he has fourteen angles. Note the
on your Adventure Sheet if you
wish to take it.`,
GOTO,
"Book1/10.js",
`go to 10`,
