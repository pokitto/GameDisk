save("save/bookmark", "Book1/367.js");
...
`
  ...
  You have attempted to steal the
chain mail before. This time,
security has been doubled with
warrior priests of Tyrnai in
abundance. Inside the temple,
there are two more of the
bullheaded iron golem guards, and
you realize there is no way you
can succeed.

  You head back to the city centre.`,
GOTO,
"Book1/400.js",
`
go to 400`,
