save("save/bookmark", "Book1/239.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The climb is long and hard, but at
last you heave yourself up on to
the top of Devil's Peak - a flat
expanse of weathered black rock.
If you have the codeword Altitude,`,
GOTO,
"Book1/126.js",
`
go to 126`,
