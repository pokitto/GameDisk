save("save/bookmark", "Book1/48.js");
...
`
  ...
  The warden is in charge of
security. 'We have had an
unfortunate, umm... accident,' he
says worriedly. 'In the crypt
below the temple we sometimes
experiment with the corpses of the
dead - you know, the occasional
zombie, part of the rituals in
honour of the particular aspect of
Nagil we revere here. It seems a
ghoul has escaped from these pits,
and is terrorizing the city at
night. We'd rather someone like
you sorted the problem out before
the city militia got to hear of
it. Destroy it and bring me the
ghoul's head.'
`,
MARK,
`  If you want to take up the
mission, record the codeword Ague
. 'Search for it at night!' says
the warden as you leave.`,
GOTO,
"Book1/100.js",
`go to 100`,
`
