save("save/bookmark", "Book1/157.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You try to prove your loyalty to
the new regime, but they don't
believe a word of it. They beat
you into unconsciousness, and
leave you lying in the gutter.
They rob you of all the money you
had, but leave your possessions
untouched. You come round with
only 3 Stamina points .`,
GOTO,
"Book1/10.js",
`go to 10`,
`.`,
