save("save/bookmark", "Book1/32.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You head across the hot, dusty and
sparsely vegetated land. Vultures
circle overhead - presumably they
think you're going to die. You
wander on, until you come to a
ridge. Down below, in a shallow
valley, is a great mound of earth.
Scorpion men crawl in and out of
the many burrows that riddle the
earth. The number of scorpion men
in the valley makes your heart
quail; unless you have the
codeword _ Artefact _ , the place
is too deadly to enter. If you
have the codeword Artefact,`,
GOTO,
"Book1/406.js",
`go to
406`,
