save("save/bookmark", "Book1/247.js");
...
`
  ...
  The sound was the click of a
secret door sliding open in the
wall of the caverns. With a swift
motion, you step up beside it,
back to the wall. A figure emerges
but you are able to ambush the
ambusher - a deft blow to the back
of the head sends the dark figure
crashing to the ground.

  Another steps forth, however,
shouting in a guttural voice. You
realize that the figures are
ratmen - manlike creatures that
stand on two legs, but which have
the tail and hairy features of a
gigantic rat.
`,
MARK,
`  You must fight the ratman. If you
have some * rat poison * , you can
apply it to the blade of your
weapon and add 3 to your dice
rolls, for this fight only. If you
use the * rat poison * , cross it
