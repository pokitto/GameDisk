save("save/bookmark", "Book1/130.js");
...
`
  ...
  You are greeted by several of the
knights.

  'We'll not fight you anymore,'
says the Blue Dragon Knight.

  'We keep losing,' says the Green
Dragon Knight.

  'And it's costing us a fortune in
armour, not to say a lot of
bruises!' says the Red Dragon
Knight.

  You are turned away, unless you
have the codeword Axe, in which
case`,
GOTO,
"Book1/521.js",
`go to 521`,
