save("save/bookmark", "Book1/593.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are under a curse. You remember
what you were told - to life the
curse, you have to throw a *
weapon (COMBAT +1) * into the
waters. If you have such a weapon,
