save("save/bookmark", "Book1/518.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are on the road between the
Citadel of Velis Corin and Fort
Mereth. This is quite rarely
travelled - the military
guardposts are few and far
between. . Lose 10 Shards gambling
(if you have it) Nothing happens A
sweet spring heals you of up to 3
Stamina points When you are ready,
you can:
  `,
GOTO,
"Book1/495.js",
...
GOTO,
"Book1/271.js",
`Head for the Citadel of Velis
Corin`,
`
  `,
GOTO,
"Book1/299.js",
`Travel to Fort Mereth`,
`
  `,
GOTO,
"Book1/60.js",
`Go south west into wild country`,
MARK
];
