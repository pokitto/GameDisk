save("save/bookmark", "Book1/Adventurers.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Charisma Combat Magic Sanctity
Scouting Thievery 4 2 3 6 4 2 2 2
6 1 5 3 5 4 4 1 2 6 6 3 4 3 2 4 3
6 2 4 3 2 2 5 2 3 6 4`,
MARK
];
