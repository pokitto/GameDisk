save("save/bookmark", "Book1/312.js");
...
`
  ...
  'Nerech's a dangerous place -
even its coastal waters, Cap'n,'
says the first mate. The crew
won't follow you there if they
don't think you're good enough to
lead them!'

  If your Rank is 4 or more,`,
GOTO,
"Book4/50.js",
`turn
to paragraph 50 in The Plains of
Howling Darkness`,
`.

  If your Rank is less than 4, the
first mate advises you against
making the ocean journey. If you
take his advice,`,
GOTO,
"Book1/507.js",
`go to 507`,
...
MARK,
`at a difficulty of 11`,
`to convince
the crew to follow you.`,
MARK
];
