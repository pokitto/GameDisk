save("save/bookmark", "Book1/205.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The runes are written in Old
Shadar, an ancient language from
thousands of years ago. You
realize that the runes form a
spell that will give you the power
to breathe underwater for a few
hours.
  `,
GOTO,
"Book1/493.js",
`Use the spell and swim out to
sea`,
`
  `,
GOTO,
