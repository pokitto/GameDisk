save("save/bookmark", "Book1/202.js");
...
`
  ...
  Gingerly, you open the door. It
leads to a curtained alcove,
through which you observe the room
beyond. It is a long, low hall -
clearly an ancient Uttakin temple,
from a time when the Masked Lords
of Uttaku ruled all of Harkuna,
but now part of the sewers of
Yellowport.

  A cheap wooden chair has been
placed on the altar to act as a
throne. On it sits a large and
extremely ugly ratman. He has a
tacky amulet around his neck, and
a rusty iron hoop for a crown.
About four ratmen are kneeling
before him, engaged in`,
MARK,
`conversation.

  'But, Skabb...' one of the rat
men is saying.

  'That's Great King Skabb to you,
dung-breath!!' bellows the rat on
the throne.
  `,
GOTO,
"Book1/428.js",
`Charge in to the attack`,
`
  `,
GOTO,
"Book1/595.js",
`Sneak in to assassinate the king`,
`
  `,
GOTO,
"Book1/24.js",
`Use sorcery to get close to
Skabb`,
`
  `,
GOTO,
