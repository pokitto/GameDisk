save("save/bookmark", "Book1/429.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The gloomy wreck is filled with
coral-encrusted skeletons of its
drowned crew. You find the
captain's cabin. Inside, a figure
still sits in a chair, a chest of
gems at its feet. With a thrill of
horror, you realize it is a ghost,
an undead remnant of a pirate
captain, steeped in evil, its
nacreous, fish-gnawed flesh still
pulsing with a kind of half-life.
  `,
GOTO,
"Book1/89.js",
`Swim straight in and grab the
chest`,
`
  `,
GOTO,
"Book1/363.js",
`Try to steal it without being
seen`,
MARK
];
