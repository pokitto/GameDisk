save("save/bookmark", "Book1/511.js");
...
`
  ...
  Your arcane knowledge tells you
much about the undead. Ghouls are
known to eat the flesh of the dead
as well as the living. They like
to make their homes in crypts and
graveyards and they never venture
out during the day, as sunlight
burns their pallid undead flesh.
Also, they cannot abide a powder
of * salt and iron filings * mixed
together.

  You can purchase these
ingredients for 15 Shards at many
a market stall. If you make the
purchase, note you have on your
Adventure Sheet.
`,
MARK,
`  When you are ready, you set off
to search the cemeteries of
Marlock City.`,
GOTO,
"Book1/extra_192.js",
