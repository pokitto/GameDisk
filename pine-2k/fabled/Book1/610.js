save("save/bookmark", "Book1/610.js");
...
you find nothing of interest at
the market -`,
GOTO,
"Book1/400.js",
`turn back to 400`,
`
immediately. Otherwise, put a tick
in the box and read on.

  At nightfall, the market is kept
open for a special sale. A cage
with a steel floor is wheeled out.
Inside is a dark, manlike shape.
It seems to radiate shadows, for
you can barely make it out.

  The slaver says, 'A trau, ladies
and gentlemen. Excellent miners,
though they have to be chained
with cold iron at all times.'
`,
MARK,
`  The price is 100 Shards. To buy
the trau, cross off the money and
turn to * 545 *`,
GOTO,
"Book1/545.js",
`go to 545`,
`.
Otherwise, you leave the market,`,
GOTO,
"Book1/400.js",
`
go to 400`,
