save("save/bookmark", "Book1/489.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Later, in your cabin, you examine
the pearls more closely. To your
horror, they lose their pearly
sheen and return to their natural
state - tiny pebbles. Some
enchantment had been laid upon
them to make them look like
pearls. Cursing the young Sea
Gypsy, you vow to be more careful
next time.`,
GOTO,
"Book1/85.js",
`go to 85`,
