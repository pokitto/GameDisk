save("save/bookmark", "Book1/439.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your ship is sailing in the coastal
waters beside Yellowport.
  `,
GOTO,
"Book1/555.js",
`Sail into Yellowport Harbour`,
`
  `,
GOTO,
"Book1/430.js",
`Sail north east towards Scorpion
Bight`,
`
  `,
GOTO,
"Book1/120.js",
`Sail south west along the coast`,
`
  `,
GOTO,
"Book1/366.js",
