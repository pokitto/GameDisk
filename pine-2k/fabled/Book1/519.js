save("save/bookmark", "Book1/519.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your crew have driven off the other
ker'ilk, which dive into the sea.
The ship was carrying 1 Cargo Unit
of furs , which you can take if
your ship has room. You clean up
the dead sailors, and give them a
proper burial at sea. There is
nothing else of interest, so you
sail on.`,
GOTO,
"Book1/209.js",
`go to 209`,
