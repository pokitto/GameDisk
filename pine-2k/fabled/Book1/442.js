save("save/bookmark", "Book1/442.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You set out to explore the city of
Yellowport at night, unwholesome
though it is with its reeking air
and dusty ochre streets.
  `,
GOTO,
"Book1/21.js",
`Head for the rough part of the
town`,
`
  `,
GOTO,
"Book1/178.js",
`Go to the wealthy area`,
`
  `,
GOTO,
"Book1/265.js",
