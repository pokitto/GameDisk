save("save/bookmark", "Book1/488.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You collapse, dying. A priest of
Tyrnai, however, heals you so that
you come round with 1 Stamina
point left . It is not out of
kindness that he has done this.
The priests take all your money
and possessions ( cross them off
your Adventure Sheet) and sell you
into slavery. You are set to work
in the tin mines outside the city.`,
GOTO,
"Book1/118.js",
`
go to 118`,
