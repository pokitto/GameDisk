save("save/bookmark", "Book1/4.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The priests of Alvir and Valmir are
overjoyed that you have returned
the . The high priest rewards you
with and a magic weapon, a
rune-engraved trident. Note the
weapon, a , on your Adventure
Sheet, and`,
GOTO,
"Book1/220.js",
`go to 220`,
