save("save/bookmark", "Book1/243.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You cannot find any hidden panels -
Lauria did say that the real
treasure was upstairs. You call to
her, but she doesn't reply.
  `,
GOTO,
"Book1/386.js",
`Go upstairs`,
