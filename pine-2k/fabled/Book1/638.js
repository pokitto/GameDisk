save("save/bookmark", "Book1/638.js");
...
`
  ...
  You know from ancient texts of
arcane lore that the repulsive
ones cannot stand bright light.
Using all your magical power, you
cause the glowing moss to emit a
dazzling flash of yellow light.
Blinded for a few seconds, the
repulsive ones mill about
helplessly, and you dart in and
seize the (note it on your
Adventure Sheet).

  You swim for the Shadar Tor as
fast as you can. From here, you
can:
  `,
GOTO,
"Book1/602.js",
