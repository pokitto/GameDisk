save("save/bookmark", "Book1/456.js");
...
`go to 375`,
`. If not, but
you have the codeword Ark and the
* royal ring * ,`,
GOTO,
"Book1/255.js",
`go to 255`,
`.
  ...
  Otherwise, you tell him you have
not yet completed your mission.
You are thrown out immediately
before you have time to say more.

  'Come back when you have better
news, you worthless dog,' screams
the provost marshal.
