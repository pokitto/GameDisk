save("save/bookmark", "Book1/646.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your mind is blasted into numb
confusion by the protective spells
that guard the sacred grove. You
wander off aimlessly into the
forest, and get hopelessly lost
for days. You don't even have the
wit to eat and drink - lose 3
Stamina points . If you are still
alive, you wander through the
forest until you emerge, at last,
at the Bronze Hills.`,
GOTO,
"Book1/110.js",
`go to 110`,
