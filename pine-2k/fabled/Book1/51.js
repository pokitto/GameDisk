save("save/bookmark", "Book1/51.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The war galley puts alongside, and
grappling hooks fly through the
air, fastening your ships
together. The captain leaps across
and his men swarm on to your ship.
A battle ensues. if you are a
Warrior , or two dice if you
belong to any other profession.
Add your Rank to this roll. Then,
if your crew is poor quality,
subtract 2 from the total. If the
crew quality is good, add 2. If
the crew quality is excellent, add
3.`,
GOTO,
"Book1/680.js",
`Calamity; you are killed`,
GOTO,
"Book1/153.js",
`
Crushing defeat; lose 1-6 Stamina`,
GOTO,
"Book1/242.js",
`
A draw`,
