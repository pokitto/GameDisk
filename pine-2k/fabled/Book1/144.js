save("save/bookmark", "Book1/144.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You call on the powers of the gods,
to banish this foul, blasphemous
travesty of life. The Ghoul
shrinks back for a moment,
snarling.`,
GOTO,
"Book1/extra_31.js",
`Make a SANCTITY roll at
a difficulty of 10`,
`.`,
MARK
];
