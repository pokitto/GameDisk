save("save/bookmark", "Book1/26.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You set sail for Dweomer. The
journey takes a few days but,
amazingly, it is uneventful. The
captain can't believe his luck, as
you disembark at Dweomer harbour,
on the Sorcerers' Isle.`,
GOTO,
"Book3/100.js",
`Turn to
paragraph 100`,
