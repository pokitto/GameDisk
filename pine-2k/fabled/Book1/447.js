save("save/bookmark", "Book1/447.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You find yourself washed up on a
rocky shore, beneath towering
cliffs. You are battered and cold,
but lucky to be alive. Eventually,
you find a path up the cliff. You
climb up, to find yourself at the
Shadar Tor.`,
GOTO,
"Book1/35.js",
`go to 35`,
