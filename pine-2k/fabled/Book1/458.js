save("save/bookmark", "Book1/458.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The road between Caran Baru and
Fort Mereth is another military
highway for transporting troops
and supplies.
  `,
GOTO,
"Book1/60.js",
`North into the country`,
`
  `,
GOTO,
"Book1/548.js",
`South to the farmlands`,
`
  `,
GOTO,
"Book1/400.js",
`South west to Caran Baru`,
`
  `,
GOTO,
"Book1/299.js",
`North east to Fort Mereth`,
MARK
];
