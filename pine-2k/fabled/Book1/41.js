save("save/bookmark", "Book1/41.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The inside of the dome is lit with
an eerie yellowish glow that comes
from the sea-moss that carpets the
ceiling. At the far end, a grotto
in the wall contains an idol made
from sea-shells and coral,
presumably of Oannes, the god of
the repulsive ones. At its feet
lies the * golden net * of Alvir
and Valmir, the object of your
quest. Between you and it swim
several of the giant
squid-creatures, carrying out
various undersea chores.
  `,
GOTO,
"Book1/35.js",
`Swim back to the Shadar Tor`,
`
  `,
GOTO,
"Book1/121.js",
`Fight your way to the golden net`,
`
  `,
GOTO,
"Book1/592.js",
`Trust your magical prowess`,
`
  `,
GOTO,
"Book1/487.js",
`Rack your memory for a solution`,
MARK
];
