save("save/bookmark", "Book1/42.js");
...
`
  ...
  Two hulking shapes appear out of
the shadows as if from nowhere.
They are hideous creatures -
manlike, standing on two legs, but
with the tail and hairy features
of a gigantic rat. Their yellowing
teeth snap at you as they lunge
for you; the ratmen also wield
wicked-looking shortswords in
their hands.

  'Gut the human!' yells one of
them in a bestial voice.

  You must fight them, both at
once, as if they were one
opponent. If you have some * rat
poison * , you can add 3 to your`,
MARK,
`dice rolls. Cross the * rat poison
* off the Adventure Sheet if you
use it.
