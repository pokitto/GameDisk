save("save/bookmark", "Book1/184.js");
...
`
  ...
  The Blue Griffon Tavern is
frequented by soldiers and
mercenaries. The tavern costs you
1 Shard a day. Each day you spend
here , you can recover 1 Stamina
point if injured, up to the limit
of your normal unwounded Stamina
score.

  If you have the codeword Axe or
if you have a * black dragon
shield * , and want to find Yanryt
the Son,`,
GOTO,
"Book1/451.js",
`go to 451`,
`.
  ...
  If not, but you want to spend a
further 3 Shards buying drinks all
round at the bar, and listen for
rumours, turn to * 341 *`,
GOTO,
"Book1/341.js",
`go to 341`,
MARK,
`. Or you can return to the town
centre -`,
GOTO,
"Book1/400.js",
`go to 400`,
