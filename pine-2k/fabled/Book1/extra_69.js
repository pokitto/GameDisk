...
function success(ability){
    f_goto("Book1/625.js", "Success!");return;
}

function fail(){
    f_goto("Book1/279.js", "Failure!");return;
}

function update(){
  cursor(0,0);
  print("Make a SANCTITY roll at a difficulty of 8");

  print(prefixes[choice == 0]); print(" sanctity: "); print(abilities[3]);
