save("save/bookmark", "Book1/216.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The cry goes up throughout the
palace, 'Murder! Assassin!' and
the hunt is on - for you. You will
need all your skill to get out of
the palace alive. , subtracting
one if you are a Rogue,
Troubadour, or a Wayfarer. If you
score less than or equal to your
Rank, . Otherwise, .`,
MARK
];
