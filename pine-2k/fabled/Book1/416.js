save("save/bookmark", "Book1/416.js");
...
`
  ...
  'The Violet Ocean's a dangerous
place, Cap'n', says the first
mate. 'The crew probably won't
follow you there if they don't
think you're good enough!'

  If your Rank is 4 or more, you
can take the ship south-west,`,
GOTO,
"Book3/77.js",
`turn
to paragraph 77 in Over the
Blood-Dark Sea`,
`. Or you can head
south-east,`,
GOTO,
"Book3/66.js",
`turn to paragraph 66
in Over the Blood-Dark Sea`,
`.

  If your Rank is less than 4, the
first mate advises you against the
ocean journey. If you take his
advice,`,
GOTO,
"Book1/559.js",
`turn back to 559`,
...
`,
MARK,
`  If you insist on making the trip,
you need to`,
GOTO,
"Book1/extra_156.js",
`Make a CHARISMA roll
at a difficulty of 12`,
`to convince
the crew to follow you. If you
succeed, you can take the ship
south-west, turn to paragraph 77
in Over the Blood-Dark Sea , or
south-east - turn to 66 in Over
the Blood-Dark Sea . If you fail,`,
GOTO,
"Book1/559.js",
`
turn back to 559`,
