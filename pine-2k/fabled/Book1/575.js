save("save/bookmark", "Book1/575.js");
...
`
  ...
  You hand him the * black dragon
shield * . Cross it off your
Adventure Sheet, and lose the
codeword Axe .

  'You are indeed worthy,' he says.

  'And will you teach me your
fighting arts?' you ask.

  'You have already learned all I
can teach you,' he says.

  You realise that what he says is
true - your defeat of the Black
Dragon Knight has taught you much.
Gain 1 Rank and . The score is the
number of Stamina points you can`,
MARK,
`add to your unwounded total ,
permanently. Also, don't forget to
increase your Defence by 1 as a
result of your gain in Rank.

  You look up, but Yanryt the Son
has gone.
