save("save/bookmark", "Book1/381.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You dart down a side tunnel but are
horrified to meet several ratmen
coming to meet you while your
pursuers close in behind. You are
caught in a vice and, though you
fight with desperate bravery, you
are overcome.`,
GOTO,
"Book1/308.js",
`go to 308`,
