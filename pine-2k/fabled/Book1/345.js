save("save/bookmark", "Book1/345.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` A ship, impaled on some rocks, is
breaking up. Nothing remains save
for rotten timbers. However, a
little bottle is bobbing in the
waves. Inside, a message reads,
'Never sail at night through rocky
waters.' You sail on.`,
GOTO,
"Book1/209.js",
`go to 209`,
