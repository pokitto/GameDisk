save("save/bookmark", "Book1/680.js");
...
`
  ...
  You are dead. If you have a
resurrection deal, turn to the
section noted on your Adventure
Sheet after first erasing your
current possessions, money, and
any details on your Ship's
Manifest.

  If you don't have a resurrection
arranged, this is the end and you
can only start afresh with a new
character. First make sure to
erase all ticks, codewords, and
Adventure Sheet details in all
your _ Fabled Lands _ books. You
can begin at * 1 * in any of the
books of the series.`,
MARK
];
