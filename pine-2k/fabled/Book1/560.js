save("save/bookmark", "Book1/560.js");
...
`
  ...
  You are crossing the western
wilderness, an expanse of wild,
sparsely-populated countryside. A
few trappers and woodsmen make a
living from the natural resources
of the area.

  A tall spire of rock, a towering
anomaly of geology, rises up into
the clouds, dominating the
horizon. A local hunter tells you
it is known as Devil's Peak and
that the summit is infested with
demons.
  `,
GOTO,
"Book1/658.js",
...
GOTO,
"Book1/99.js",
`Head west to the river`,
`
  `,
GOTO,
"Book1/47.js",
`Head north into the Forest of
Larun`,
MARK,
`  `,
GOTO,
"Book1/175.js",
`Go south to the Curstmoor`,
`
  `,
GOTO,
"Book1/558.js",
`Travel east to the road`,
MARK
];
