save("save/bookmark", "Book1/463.js");
...
man you shared a prison cell with.
This must be the lair of the
gorlock that is said to have
backward-pointing feet, so that
the tracks it leaves will always
show the opposite direction of
travel! You realize that this
means the gorlock is inside the
cave.
  `,
GOTO,
"Book1/174.js",
