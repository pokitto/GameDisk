save("save/bookmark", "Book1/365.js");
...
`
  ...
  Sul Veneris wakes up the moment
you remove the stake. He rips the
other stakes out of the ground,
and soars into the air, with a
shout like a clap of thunder. He
swings his hammer around his head,
and bolts of lightning leap forth
to strike the storm demons.

  As he rises into the clouds in
pursuit of the demons, a bolt of
lightning streaks from his hand
and strikes you full force! You
are thrown backwards but to your
amazement you are unhurt. In fact,
you feel empowered by the blast.
Gain 3 points of Stamina
permanently .`,
MARK,
`
  You have freed Sul Veneris, the
Lord of Thunder. Record the
codeword Aloft before climbing
down to the bottom.`,
GOTO,
"Book1/658.js",
`go to 658`,
