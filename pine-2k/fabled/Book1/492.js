save("save/bookmark", "Book1/492.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are on a rough track that runs
between Venefax and the
territories of the scorpion men,
slogging your way through hot, dry
scrubland. A hawk circles
