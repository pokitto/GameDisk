save("save/bookmark", "Book1/466.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The road between Blessed Springs
and Fort Brilon is patrolled by
troopers of the Sokaran army. The
fort is well-supplied from Blessed
Springs, and traffic abounds.
  `,
GOTO,
"Book1/259.js",
`Visit Fort Brilon`,
...
GOTO,
"Book1/510.js",
`Head for Blessed Springs`,
`
  `,
GOTO,
"Book1/548.js",
`Set off north into the farmlands`,
MARK
];
