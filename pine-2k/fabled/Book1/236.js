save("save/bookmark", "Book1/236.js");
...
`
  ...
  You find Fourze inside,
desperately trying to get out of
his suit and run off. At the sight
of a hardened adventurer, rather
than a timid villager, he
surrenders and confesses all. He
terrified people with the monster
disguise to keep them away from
the farm. He and his men were
kidnapping villagers, chaining
them in the cellar below and
selling them to a slaver from
Caran Baru, for work in the slave
mines. You find Haylie and several
other villagers down below in the
cellar.

  'Don't hurt me,' begs Fourze,`,
MARK,
`'I'm only trying to make a few
Shards.'

  'What! By selling your own people
into slavery,' says one of the
villagers, giving him a good kick.
