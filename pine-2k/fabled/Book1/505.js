save("save/bookmark", "Book1/505.js");
...
`
  ...
  Cross the * silver nugget * off
your Adventure Sheet.

  'Excellent,' says the dragon,
catching the nugget in one of its
clawed forelimbs.

  With that, it rolls over, and
dives down into the lake. At the
last second, its tail whips up out
of the water, inches from your
face.
