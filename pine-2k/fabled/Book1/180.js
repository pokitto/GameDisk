save("save/bookmark", "Book1/180.js");
...
Immediately the symbols on the
stone begin to glow with red-hot
energy; your hair stands on end
and your body tingles. A crackling
nimbus of blue-white force engulfs
you, the sky darkens and thunder
and lightning crash and leap
across the heavens. Suddenly, your
vision fades, and everything goes
black.

  When your sight returns, you find
yourself outside the gates of a
huge, fortified city. A guard
starts in surprise at the sight of
you. Then he shakes his head as if
to clear it, sure he must have`,
MARK,
`imagined what he just saw!

  The gates open, and a troop of
heavy cavalry canter past.

  'Make way for the Marlock City
militia!', says the guard.

  When they have passed, you walk
into the city.`,
GOTO,
"Book1/100.js",
`go to 100`,
