save("save/bookmark", "Book1/482.js");
...
Lacuna's blessing. A non-initiate
must pay 25 Shards. Cross off the
money and mark SCOUTING in the
Blessings box on your Adventure
Sheet.

  The blessing works by allowing
you to try again when you make a
failed SCOUTING roll. It is only
good for one reroll. When you use
the blessing, cross it off your
Adventure Sheet. You can have only
one SCOUTING blessing at any one
time. Once it is used up, you can
return to any branch of the temple
of Lacuna to buy a new one.`,
MARK,
`
