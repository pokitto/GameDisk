save("save/bookmark", "Book1/121.js");
...
`
  ...
  You wait outside, hoping to take
the repulsive ones singly as they
emerge. You will have to fight the
three of them, but you may do so
one at a time.

  Subtract 1 from your dice rolls
for every fight because you are
unused to underwater combat. _
[Their Defence scores have been
raised by 1 instead --Ed] _
...
`go to 213`,
`
. If you lose, your adventuring
days are over, unless you have a
resurrection deal .`,
MARK
];
