save("save/bookmark", "Book1/91.js");
...
`
  ...
  He smiles and takes you into the
Gambler's Den. It is a smokefilled
casino, full of all kinds of
dubious characters, playing cards
and dice. If you want to gamble,
decide how much you want to bet,
to a maximum of 20 Shards, and
roll two dice . win five times
your bet win twice your bet lose
your bet win twice your bet win
five times your bet

  When you are ready to leave, put
a tick in the box and`,
GOTO,
"Book1/109.js",
`go to 109`,
`,
unless the box is already ticked,
in which case`,
GOTO,
"Book1/100.js",
`go to 100`,
