save("save/bookmark", "Book1/98.js");
...
`
  ...
  The soldier recognizes you and
bows.

  'My lord,' he says, 'We are a
small group now, left here to act
as raiders behind enemy lines.
Thanks to your heroic actions, the
Citadel of Velis Corin is now ours
- the king has moved his court
there. Go to the citadel if you
would speak with the king.'

  There is nothing else of interest
in the mountains, so you return to
the foothills.`,
GOTO,
"Book1/474.js",
`go to 474`,
