save("save/bookmark", "Book1/61.js");
...
`
  ...
  'Wait,' you cry, 'I have seen the
light! I wish to join your cult!'

  'What!' yells the chef. Then his
shoulders sag in resignation.

  'We cannot refuse a new member,'
says the leader with obvious
disappointment. 'And we cannot eat
our own people,' he adds sadly.

  A short ceremony later -
fortunately, the initiation does
not involve any cannibalistic
rites - and you are a full member
of the Cult of Badogor. Write in
the Titles and Honours box on your
Adventure Sheet. You lose 1 point`,
MARK,
`of SANCTITY permanently for
joining such a vile cult.

  You take your leave, and they
wish you well, all smiles and
friendship.

  'Remember, never say his name!
And don't forget to bring us new
recruits,' says the leader. 'And
some people for dinner!' adds the
chef.

  Hastily, you head for the city
centre.`,
GOTO,
"Book1/10.js",
`go to 10`,
