save("save/bookmark", "Book1/602.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are travelling the road between
the Shadar Tor and Trefoille. You
pass a convoy of masons,
carpenters and builders heading
for Trefoille with an escort of
Sokaran soldiers.
  `,
GOTO,
"Book1/250.js",
