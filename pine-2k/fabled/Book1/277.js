save("save/bookmark", "Book1/277.js");
...
`
  ...
  A patrol of militiamen -
mercenaries in the pay of the
dictator, General Grieve Marlock -
...
`immediately.
  ...
  If not, but you are a Protector
of Sokara, they greet you politely
and salute. You return to the city
centre without incident -`,
GOTO,
"Book1/10.js",
`go to 10`,
`
.
  ...
  Otherwise they decide you will be
arrested unless you pay 15 Shards
as 'taxes'. If you refuse, or
don't have 15 Shards,`,
GOTO,
"Book1/538.js",
`go to 538`,
`.`,
MARK,
`If you hand over the money, cross
it off and the militiamen leave
you alone -`,
GOTO,
"Book1/10.js",
`turn back to 10`,
