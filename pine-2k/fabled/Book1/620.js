save("save/bookmark", "Book1/620.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Some local militiamen approach you
with ill intent, presumably with a
view to extorting a few Shards.
They recognize you as a favourite
of General Marlock, however, and
leave you well alone, bowing and
scraping to avoid your anger.
Nothing else occurs this night.`,
GOTO,
"Book1/100.js",
`go
to 100`,
