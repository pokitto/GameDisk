save("save/bookmark", "Book1/250.js");
...
`
  ...
  The city of Trefoille is a
terrifying vision of apocalyptic
destruction. It had once been a
thriving crossroads town, but now
it is a burnt-out hulk. It was
almost razed to the ground when it
declared for the late king, during
the recent civil war, and tried to
hold out against the army of
Grieve Marlock, the current
Protector-General of Sokara. It
was then sacked by the general's
mercenaries, and General Marlock
is now trying to rebuild it -
craftsmen are hard at work
everywhere.

  If you have the codeword Amends,`,
MARK,
`and want to visit Oliphard the
Wizardly,`,
GOTO,
"Book1/656.js",
`go to 656`,
