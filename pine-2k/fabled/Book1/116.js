save("save/bookmark", "Book1/116.js");
...
`
  ...
  Put a tick in the box . If there
...
immediately. Otherwise read on.
  ...
  You realize the creature is one
of the legendary repulsive ones.
It is swimming past you, intent on
its own business, so you follow
it, in the hope it will lead you
to the sunken city of Ziusudra.`,
GOTO,
"Book1/547.js",
`go
to 547`,
