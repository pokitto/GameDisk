save("save/bookmark", "Book1/92.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` He falls dead at your feet.
Searching him, you find you can
take if you wish. Then you flip up
his eyepatch. Nestling in the
eye-socket is a sparkling gem, a
flame opal. You pluck it free.
Note the on your Adventure Sheet
and lose the codeword _ Barnacle _
. You hurry off, before a patrol
arrives.`,
GOTO,
"Book1/400.js",
`go to 400`,
