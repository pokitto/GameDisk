save("save/bookmark", "Book1/104.js");
...
`
  ...
  Lose the codewords Almanac ,
Brush and Eldritch if you have
them. You can invest money in
multiples of 100 Shards. The guild
will buy and sell commodities on
your behalf using this money until
you return to collect it.

  'Don't forget that you can lose
money as well,' mutters a sullen
merchant who leaves the guild
penniless.

  Write the sum you are investing
in the box here - or withdraw a
sum invested previously. Then`,
GOTO,
"Book1/571.js",
`turn
back to 571`,
