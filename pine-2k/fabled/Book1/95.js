save("save/bookmark", "Book1/95.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are greeted warmly and politely
by the provost marshal who treats
you as one if his own. However,
there are no more missions, and
after thanking you once again, he
politely sends you on your way.`,
GOTO,
"Book1/10.js",
`
Return to 10`,
