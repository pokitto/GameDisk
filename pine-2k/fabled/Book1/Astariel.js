save("save/bookmark", "Book1/Astariel.js");
...
`
  ...
  Astariel has the wanderlust, and
chafes if he has to remain in one
place for any length of time. He
enjoys the freedom of the open
road and the thought that he never
knows what adventures each new day
will bring. He lives by his wits
and is a familiar figure at tavern
firesides, where he regales
travellers with his tales.

  You can play as Astariel, or as a
troubadour with a different name
(enter it in the 'Name' field). To
...
const abilities = [6,3,4,3,2,4];
save("save/abilities", abilities);


save("save/name", "Astariel Skysong");
