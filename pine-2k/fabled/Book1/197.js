save("save/bookmark", "Book1/197.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The blessing of Sig costs 10 Shards
if you are an initiate, 30 Shards
otherwise. If you buy the
blessing, cross off the money and
mark THIEVERY in the Blessings box
on your Adventure Sheet. The
blessing works by allowing you to
reroll any failed THIEVERY attempt
once. When you use the blessing,
cross it off your Adventure Sheet.
You can then make a second try at
the roll. You can have only one
blessing for each ability at any
one time. Once your THIEVERY
blessing is used up, you can
return to any branch of the temple
of Sig to buy a new one. When you
are finished here,`,
GOTO,
"Book1/235.js",
`turn back to
