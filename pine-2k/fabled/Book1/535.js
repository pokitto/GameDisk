save("save/bookmark", "Book1/535.js");
...
`
  ...
  The House of Priests is an
impressive building, a roundhouse
of multi-coloured bricks. The
myriad colours give it a bizarre
and garish look, calculated to
unsettle the visitor. Inside, a
hundred offices team with the
administration of the polytheistic
religion of Sokara and Golnir.
...
`go to 9`,
`. If
not, there is little for you here,`,
GOTO,
"Book1/100.js",
`
turn back to 100`,
