save("save/bookmark", "Book1/60.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are crossing the wild country
of north-east Sokara. . Caught in
an animal trap! Lose 2 Stamina
Nothing happens Attacked by a
wolf, and must fight. If you win,
you get a . When you are ready,
you can go:
  `,
GOTO,
"Book1/518.js",
