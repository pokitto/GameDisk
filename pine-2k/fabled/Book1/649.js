save("save/bookmark", "Book1/649.js");
...
overjoyed to see you. The priests
already know you have been
successful in freeing Sul Veneris,
the Lord of Thunder, because their
crystal ball shows them that the
storm demons have been driven
away.

  As a reward you receive the
tuition of several high priests.
You gain 1 Rank . Roll a single
die . The result is the number of
Stamina points you gain`,
MARK,
`permanently . Also, don't forget
to increase your Defence by 1 as a
result of your gain in Rank.

  'Visit me anytime,' says the
chief administrator when you
leave.`,
GOTO,
"Book1/100.js",
`go to 100`,
