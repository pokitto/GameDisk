save("save/bookmark", "Book1/556.js");
...
`
  ...
  Gain the codeword Amends .

  You scatter the powder on the
surface of the waters. Cross the *
vial of yellow dust * off your
Adventure Sheet.

  There is a flash, and a cloud of
yellow smoke billows up out of the
pond. When it clears, you find
yourself face to face with a
white-bearded bespectacled old
man, floating a few feet off the
water! He is dressed in long,
flowing ornate robes.

  He blinks at you for a moment
before saying, 'Thank you, thank`,
MARK,
`you. That worthless apprentice of
mine! Can you imagine - I told him
to throw the dust into the holy
waters but the idiot couldn't even
be trusted to do that!'

  The old man's name is Oliphard
the Wizardly. As a reward, he
casts a spell that enhances your
skill - add one to the ability of
...
`go to 426`,
`. If
not, he thanks you and says, 'If
you ever need some help, look for
me in Trefoille.' Then he leaves -`,
GOTO,
"Book1/378.js",
`
go to 378`,
