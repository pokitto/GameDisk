save("save/bookmark", "Book1/354.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You throw , muttering a prayer for
forgiveness to the gods. The
weapon soars through the air. It
turns, and catches the sunlight,
sparkling like a flashing star,
before sinking beneath the water
with barely a splash. No ripples
appear. Your heart feels uplifted,
and the curse is no more! Delete
the curse and its effects, and
