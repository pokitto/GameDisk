save("save/bookmark", "Book1/540.js");
...
`
  ...
  Sure enough, when the scholar
leaves, purse bulging with Shards,
the two ruffians also leave. You
follow at a slight distance. As
you suspected, the ruffians wait
for a suitable moment and then set
about the scholar.

  'Help, help! Thieves!' cries the
scholar in a thin, reedy voice.
  `,
GOTO,
"Book1/100.js",
