save("save/bookmark", "Book1/297.js");
...
`
  ...
  Decide which armour and weapon
you will use in the fight. They
will be the ones you are betting
with.

  Roll a die , and check the table
below. The result is the knight
you must fight.

  Because it is not a duel to the
death, your weapons are padded, so
any Stamina you lose is not
permanent - it is recovered after
the fight.
