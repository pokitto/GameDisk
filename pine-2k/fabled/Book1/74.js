save("save/bookmark", "Book1/74.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` A fisherman will take you all the
way to Yellowport for 15 Shards.
Cross the money off your Adventure
Sheet. Amazingly, despite the
apparent fragility of the small
vessel, you arrive without
incident.`,
GOTO,
"Book1/10.js",
`go to 10`,
