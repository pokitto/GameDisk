save("save/bookmark", "Book1/577.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You recognize the tracks as those
of the legendary gorlock. You
remember that it is said to have
backward-pointing feet, so that
the tracks it leaves will always
show the opposite direction of
travel! This means that the
gorlock is currently inside the
cave.
  `,
GOTO,
"Book1/174.js",
`Challenge the beast to combat`,
`
  `,
GOTO,
"Book1/287.js",
`Wait for it to leave the cave`,
MARK
];
