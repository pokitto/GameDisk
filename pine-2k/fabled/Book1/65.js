save("save/bookmark", "Book1/65.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` There are three stone gates
engraved with ancient runes. Each
gate is marked with a name -
Yellowport, Marlock City, and
Wishport. From here, you can see
the coast and the whole island,
...
GOTO,
"Book1/8.js",
`Step through the Yellowport arch`,
`
  `,
GOTO,
"Book1/180.js",
`Step through the Marlock City
arch`,
`
  `,
GOTO,
"Book1/330.js",
`Step through the Wishport arch`,
MARK
];
