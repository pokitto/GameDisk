save("save/bookmark", "Book1/44.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You decide that discretion would be
the better part of valour in this
case, and step aside. The officers
laugh contemptuously, and swagger
past. Nothing else happens
tonight.`,
GOTO,
"Book1/100.js",
`go to 100`,
