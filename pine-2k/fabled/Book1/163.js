save("save/bookmark", "Book1/163.js");
...
`
  ...
  You hold up the * pirate
captain's head * . The guildmaster
looks up expectantly, but his face
quickly darkens.

  'This is not Amcha!! Everyone
knows he has only one eye - this
poor fellow is probably some
beggar you killed in an alley
somewhere. You think you can
swindle the guild with this
pathetic ruse! Out! Get out! And
don't come back until you bring me
the head of Amcha One-Eye!'

  The guildmaster has you removed
by his guards, and you are dumped
into the street.`,
GOTO,
"Book1/100.js",
`go to 100`,
