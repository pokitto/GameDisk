save("save/bookmark", "Book1/558.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You join the much-travelled road
that connects Trefoille and Caran
Baru. The traffic mostly consists
of convoys of troops and supplies.
  `,
GOTO,
"Book1/250.js",
`Go to Trefoille`,
...
GOTO,
"Book1/175.js",
`Go north into the Curstmoor`,
`
  `,
GOTO,
"Book1/310.js",
`Go east to the river`,
MARK
];
