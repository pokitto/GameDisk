save("save/bookmark", "Book1/214.js");
...
`
  ...
  You try to stop the panic, but
your men are too far gone. They
are already diving over the side,
trying to swim back to your ship.
Unfortunately, they are even more
vulnerable in the sea, and the
ker'ilk take them at will. Soon
you are all overwhelmed, and you
are taken alive to be injected
with eggs - a most horrible end.

  Your adventures are over, unless
you have a resurrection deal with
a temple.`,
MARK
];
