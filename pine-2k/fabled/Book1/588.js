save("save/bookmark", "Book1/588.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You break past the militia, leap
over the table and rush out of the
door. From behind you can hear
muffled curses and then a fiery
blast which sizzles wetly in the
damp yellow fog, but you don't
look back and you don't stop
running until you are well clear
of the house.`,
GOTO,
"Book1/10.js",
`go to 10`,
