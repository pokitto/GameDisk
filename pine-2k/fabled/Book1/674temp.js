save("save/bookmark", "Book1/674temp.js");
...
`
  ...
  You realise from your magical
studies that there is a safe path
through the pentacle. If you step
off the correct symbols, drawn on
the ground, there is no telling
what sorcerous trap you will set
off.

  If you decide the whole thing is
too dangerous, and leave,`,
GOTO,
"Book1/47.js",
`go to 47`,
`
.
  ...
  If you want to try the path to
the sarcophagus,`,
GOTO,
"Book1/extra_260.js",
`Make a THIEVERY
roll at a difficulty of 9`,
`.`,
MARK
];
