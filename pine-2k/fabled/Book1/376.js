save("save/bookmark", "Book1/376.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You manage to slip out of your
chains, and sneak off into the
tunnels. You make it to the
outside, but a troop of guards and
a pack of dogs finally track you
down. The fate of all escaped
slaves is death - you are
executed. Your adventuring days
