save("save/bookmark", "Book1/99.js");
...
River Grimm, a great, powerful
river, which rushes past towards
the sea. You can travel to Golnir
from here.
  `,
GOTO,
"Book2/168.js",
`Cross the bridge to Conflass`,
`
  `,
GOTO,
"Book2/306.js",
`Ford the river to the south`,
`
  `,
GOTO,
"Book1/333.js",
...
GOTO,
"Book1/175.js",
`Head for the Curstmoor`,
`
  `,
GOTO,
"Book1/560.js",
`Head towards Devil's Peak`,
`
  `,
GOTO,
"Book1/579.js",
`Go south to the mouth of the
river`,
`
  `,
GOTO,
