save("save/bookmark", "Book1/471.js");
...
`
  ...
  If you have the codeword Animal,`,
GOTO,
"Book1/369.js",
`
go to 369`,
`. If not, read on.
  ...
  The priestess, dressed in silken
robes, and wearing a wreath of oak
leaves, says, 'I have need of an
adventurer like yourself. For
arcane reasons involving the
secret mysteries of Lacuna, I need
the tusk of a boar. A were-boar,
in fact. I believe they can be
found in the Forest of the
Forsaken, in northern Golnir. Hunt
down a were-boar, and bring me a *
boar's tusk * . In return I will
teach you how to be a better
scout.'
`,
MARK,
`  If you accept the mission,
acquire the codeword Animal .
