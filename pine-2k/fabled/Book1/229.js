save("save/bookmark", "Book1/229.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The guildmaster welcomes you
warmly. He has no further missions
for you, though he treats you with
respect because you brought Amcha
to justice. If you are completely
broke, without a Shard in your
pocket or in the bank, he will
give you . If you have any money
at all, he will not help.`,
GOTO,
"Book1/100.js",
`go to
100`,
