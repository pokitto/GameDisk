save("save/bookmark", "Book1/355.js");
...
investments have done, . Also add
1 if you have the codeword _
Almanac _ , add 2 if you have the
codeword _ Brush _ , and add 3 if
you have the codeword _ Eldritch _
. Lose entire sum invested Loss of
50% Loss of 10% Investment remains
unchanged Profit of 10% Profit of
50% Double initial investment
