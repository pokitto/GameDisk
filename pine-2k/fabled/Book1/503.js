save("save/bookmark", "Book1/503.js");
...
`
  ...
  Your magical awareness tells you
that something is wrong. You
realize that the scorpion man is
an illusion - a magically created
disguise! The illusion falls away
under your keen magical sight, and
a rather fat little fellow is
standing before you, dressed in a
dirty, food-stained tunic.

  'Ah...' he says, realizing his
subterfuge has been uncovered. He
drops to his knees, pleading,
'Please don't kill me! Please
don't kill me!'

  You manage to calm him down
enough to find out his story. His`,
MARK,
`name is Kaimren the Portly, a
minor sorcerer. He came here in
the guise of a scorpion man, and
swiftly rose to power using his
magical skills. He had planned to
use the scorpion men as an army.

  Fearfully, he hands you the ,
which he stole to further his
campaign of conquest. Note it on
your Adventure Sheet.

  Then Kaimren leads you through a
secret tunnel, out of the mound,
and back to the village of
Venefax, where you hand him over
to the Venefax authorities for
trial.

  Record the codeword Afraid and`,
GOTO,
"Book1/427.js",
`go`,
MARK,
