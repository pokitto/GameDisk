save("save/bookmark", "Book1/521.js");
...
Dragon Knight on a quest that was
set for you by Yanryt the Son. You
ask the knights if he is here.

  'The Black Dragon Knight? Yes, he
is,' replies one of them. 'But he
fights only to the death - there
is no wager save the greatest of
all for him, that is to say, life
itself.'
  `,
GOTO,
"Book1/321.js",
`Fight the Black Dragon Knight`,
`
  `,
GOTO,
"Book1/276.js",
`Don't fight and leave instead`,
MARK
];
