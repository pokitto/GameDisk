save("save/bookmark", "Book1/507.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are sailing across the Sea of
Whispers with a clear, blue sky
and a salty wind to help you on
your way.
  `,
GOTO,
"Book1/195.js",
`Dock at the Isle of Druids`,
`
  `,
GOTO,
"Book1/430.js",
`Sail west towards Scorpion Bight`,
`
  `,
GOTO,
"Book1/190.js",
`Sail north west into coastal
waters`,
`
  `,
GOTO,
"Book1/312.js",
`Sail north into coastal waters`,
`
  `,
GOTO,
"Book1/13.js",
`Sail south into the Violet Ocean`,
`
  `,
GOTO,
"Book1/206.js",
`Sail east into the Unbounded
Ocean`,
MARK
];
