save("save/bookmark", "Book1/421.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The storm demons shrink back with a
wailing, mournful cry, like wind
in the trees. The power of your
faith is enough to repel them. You
work free one of the stakes
holding down Sul Veneris.`,
GOTO,
"Book1/365.js",
`go to
365`,
