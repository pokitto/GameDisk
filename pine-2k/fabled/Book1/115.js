save("save/bookmark", "Book1/115.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` If you are on a quest for the
temple of Nagil, to bring them the
head of an escaped ghoul,`,
GOTO,
"Book1/446.js",
`go to
446`,
`. If you do not want to look
for the ghoul yet, or have already
done so,`,
GOTO,
"Book1/226.js",
`go to 226`,
