save("save/bookmark", "Book1/7.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Much to your embarrassment, you get
lost in the vast forest. You
wander around for days until you
finally emerge at the Bronze
Hills.`,
GOTO,
"Book1/110.js",
`go to 110`,
