save("save/bookmark", "Book1/415.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You cannot continue. You sink to
your knees, gasping for water and
pass out. Death is not long in
coming. It is all over, unless you
