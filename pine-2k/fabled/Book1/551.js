save("save/bookmark", "Book1/551.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You cannot escape - there are too
many of them and all of them are
seasoned warriors of Tyrnai. You
are overpowered and given a savage
beating - you are reduced to only
1 Stamina point . They take all
your money and possessions. Cross
them off your Adventure Sheet. The
priests do not have you sacrificed
to Tyrnai - instead you are sold
into slavery and set to work in
the tin mines outside the city.`,
GOTO,
"Book1/118.js",
`go
to 118`,
