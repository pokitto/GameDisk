save("save/bookmark", "Book1/527.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You run off, leaving the terrible
Gob-gobbler behind. The villagers
of Venefax greet you with snorts
of derision and contempt, and the
young boy, Mikail, looks away,
disappointed. It would be prudent
to leave Venefax for a while.
  `,
GOTO,
"Book1/492.js",
`South into Scorpion Bight`,
`
  `,
GOTO,
"Book1/87.js",
`North east towards Blessed
Springs`,
`
  `,
GOTO,
