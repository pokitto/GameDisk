save("save/bookmark", "Book1/460old.js");
...
`
  ...
  You climb down an old disused
well in the poor quarter of
Yellowport.

  If you have the codeword Acid or
a * copper amulet * ,`,
GOTO,
"Book1/327.js",
`go to 327`,
...
immediately. If not, read on.
  ...
  It is dank, dark and smelly down
below. If you do not have a light
source, such as a lantern or a
torch, you will have to return to
the city -`,
GOTO,
"Book1/10.js",
`go to 10`,
`. If you are a
Mage you can use sorcery to create
light. If you have a light source,
read on.

  You follow a tunnel into the`,
MARK,
`darkness.`,
GOTO,
"Book1/164.js",
