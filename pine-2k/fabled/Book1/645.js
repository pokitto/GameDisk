save("save/bookmark", "Book1/645.js");
...
read on.
  ...
  You are brought before the
druids' leader, the Oak Druid, a
bearded fellow with earth and
leaves all tangled up in his hair.
He asks you to perform a service
for them.

  'Take this oak staff to the
Willow Druid in the forest of
Larun. The sacred grove where he
lives will be hard to find, but
I'm sure you can do it. The Willow
Druid will give you something to
bring back to me. When you return`,
MARK,
`with it, I will make you a better
Wayfarer.'

  Note the on your Adventure Sheet.
You leave the City of Trees,`,
GOTO,
"Book1/678.js",
`go to
678`,
