save("save/bookmark", "Book1/486.js");
...
`
  ...
  Everything indicated the cave is
empty so you approach carefully,
on the look out for attack from
behind. Suddenly, something rushes
out of the cave, taking you by
surprise! It is a gorlock, a beast
with legs like a bird, a body like
a reptile, with two short
forelimbs and a beaked,
lizard-like head. You see that its
two legs end in backward-pointing
feet - the tracks it leaves will
always show the wrong direction of
travel!

  It bites at you savagely, and you
lose 4 Stamina points . If you
still live, you will have to`,
MARK,
`fight.
...
`go to 315`,
`. If you
lose, your bones will join the
others at the entrance of the cave
-`,
GOTO,
"Book1/680.js",
`go to 680`,
