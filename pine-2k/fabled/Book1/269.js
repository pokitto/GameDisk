save("save/bookmark", "Book1/269.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You find a natural alcove in the
wall of a tunnel. Desperately, you
squeeze yourself into it, and fade
into the shadows. The ratmen come
bundling past, whooping and
yelling. None of them spot you,
and once they have gone you step
out, smiling to yourself.`,
GOTO,
"Book1/580.js",
`go to
580`,
