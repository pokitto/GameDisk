save("save/bookmark", "Book1/570.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` 'Aargh, you fiendish human!' roars
the tree, flailing its branches at
you. You must fight. If you reduce
the tree to 5 or less Stamina
points,`,
GOTO,
"Book1/148.js",
`go to 148`,
`. If you lose,
you are battered into
unconsciousness and wake up in the
Trading Post on 1 Stamina with all
your money gone -`,
GOTO,
"Book1/195.js",
`go to 195`,
