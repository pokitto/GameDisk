save("save/bookmark", "Book1/406.js");
...
`
  ...
  You know that the * Book of the
Seven Sages * that Pyletes wanted
you to get lies within the mound.
If you don't want to go for it
now, you can leave by`,
GOTO,
"Book1/492.js",
`turning to
492`,
`. Otherwise, you wait until
nightfall, then creep towards the
mound.
