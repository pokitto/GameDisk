save("save/bookmark", "Book1/332.js");
...
`
  ...
  The quayside at the Trading Post
is a simple affair, without the
harbour facilities or the
shipwrights of the larger ports.
There are no ships available to
buy here, but if you already own a
ship, you can buy and sell cargo.

  Prices are for single Cargo
Units. Fill in your current cargo
on the Ship's Manifest.

  You can buy a one-way passage to
Yellowport from here at a cost of
15 Shards -`,
GOTO,
"Book1/74.js",
`go to 74`,
