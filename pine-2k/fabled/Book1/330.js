save("save/bookmark", "Book1/330.js");
...
`
  ...
  You must have _ Cities of Gold
and Glory _ before you can travel
to Wishport.`,
GOTO,
"Book1/65.js",
`Turn back to 65`,
`and
choose again if you do not have
this book. Otherwise, read on.
...
you, the sky darkens and rumbles,
thunder and lightning crash and
leap across the heavens. Suddenly,
your vision fades, and everything
goes black.
`,
MARK,
`  When your sight returns, moments
later, you find yourself at the
gates of Wishport. You join the
throng of merchants and peasants
making their way into the city.`,
GOTO,
"Book2/217.js",
`
Turn to 217 in Cities of Gold and
Glory`,
`.`,
MARK
];
