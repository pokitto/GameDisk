save("save/bookmark", "Book1/Liana.js");
...
`
  ...
  Liana prefers to make her home in
mountain grottos and woodland
groves rather than in the squalid
streets of cities. She has the
agility of a gazelle, the cunning
of a fox and the ferocity of an
eagle. She has heard of a City of
Trees, deep within the forest of
the Isle of Druids.

  You can play as Liana, or as a
wayfarer with a different name
...
const abilities = [2,5,2,3,6,4];
save("save/abilities", abilities);


save("save/name", "Liana the Swift");
