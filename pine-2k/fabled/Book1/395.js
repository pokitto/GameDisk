save("save/bookmark", "Book1/395.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You make it out of the temple with
your pursuers close behind.
However, you manage to lose them
amid the alleys of Caran Baru,
hiding inside a barrel of rotting
food - garbage from the army
barracks. You emerge stinking, but
safe.`,
GOTO,
"Book1/400.js",
`go to 400`,
