save("save/bookmark", "Book1/407.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You hide in the kitchen pantry, and
then, disguised as a kitchen
scullion, sneak out unnoticed. The
skill and daring of your exploit
will be forever remembered! Long
live the rightful king!`,
GOTO,
"Book1/10.js",
`go to 10`,
`.`,
