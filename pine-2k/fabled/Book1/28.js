save("save/bookmark", "Book1/28.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You jump into the air, and hit the
ground rolling. You come up,
bruised but alive, in time to see
the horses ride straight into the
rocky wall of a low hill! To your
amazement, they pass straight
through the rock and disappear.
Silence falls across the land like
a blanket. There is no sign of
them, not even tracks. You camp
for the night and the next day set
off once more.
  `,
GOTO,
"Book1/560.js",
`North across country`,
`
  `,
GOTO,
"Book1/588.js",
