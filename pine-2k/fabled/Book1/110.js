save("save/bookmark", "Book1/110.js");
...
Hills. Virtually the whole area
has been given over to mining.
Everywhere, quarries and
mineshafts abound. It is a
horrible expanse of torn-up earth
- hardly any areas of green are
left. Great heaps of excavated
rock, leeched of their useful
minerals, mar the landscape. You
find a quarry that is open to the
public. That is to say, if you pay
50 Shards, you can dig for an hour
in a silver mine.
  `,
GOTO,
"Book1/668.js",
`Pay 50 Shards and mine for
silver`,
`
  `,
GOTO,
...
GOTO,
"Book1/47.js",
`South into the Forest of Larun`,
`
  `,
GOTO,
"Book1/333.js",
