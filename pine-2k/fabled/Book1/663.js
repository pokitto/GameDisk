save("save/bookmark", "Book1/663.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` They are too fast. You are caught
and overwhelmed. You end up as
food for scorpion larvae. Your
adventuring days are over, unless
you have a resurrection deal .`,
MARK
];
