save("save/bookmark", "Book1/643.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Gamely, you drive yourself on, but
your thirst is becoming terrible,
and soon you will be unable to
continue. If you go on, you might
die of thirst before finding a
water supply.
  `,
GOTO,
"Book1/244.js",
