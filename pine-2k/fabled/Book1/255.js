save("save/bookmark", "Book1/255.js");
...
`
  ...
  The provost marshal takes you to
an empty side chamber, away from
prying ears. Over a glass of fine
wine you tell him of your
adventures in the Coldbleak
Mountains. When you give him the
Royal Ring of the House of Corin,
he knows that Nergan is dead.
Cross the * royal ring * off your
Adventure Sheet.

  Marloes Marlock is pleased
indeed. He pays you and awards you
the title . Note it in your Titles
and Honours box. The title will
give you instant respect and
command obedience in Sokara.
`,
MARK,
`  Also, after completing such a
difficult test, you find the
experience has taught you much -
gain 1 Rank and . The result is
the number of Stamina points you
gain permanently. Note the
increase on your Adventure Sheet.
Also, don't forget to increase
your Defence by 1 as a result of
your gain in Rank.
