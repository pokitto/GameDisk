save("save/bookmark", "Book1/285.js");
...
`
  ...
  You remember a bard in a tavern
told you about Damor the Hermit,
and that he knew the secret of the
Greatest Story Ever Told so you
ask him about it.

  'Ahh,' says Damor. 'I have waited
for one such as you.' He tells you
the secret of the Greatest Story.
'Well, my young adventurer,
destiny beckons, for it is fated
that your life will be the
Greatest Story Ever Told.'

  As you consider this, you feel a
sense of momentary enlightenment.
Gain one Rank and roll one die .
The result is the number of`,
MARK,
`Stamina points you gain
permanently. Also, don't forget to
increase your Defence by 1 as a
result of your gain in Rank.

  'Right, that's that,' says Damor.
'Now, go away and don't come
back!'

  For a few hours, he lifts the
curse that soured your water so
you can make it down again safely.`,
GOTO,
"Book1/244.js",
`
go to 244`,
