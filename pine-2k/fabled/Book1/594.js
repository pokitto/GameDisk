save("save/bookmark", "Book1/594.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` 'Oh, it's you again,' says the tree
grumpily. 'All right, off you go.'
The tree uproots itself and
shuffles out of your way, leaving
you free to visit the City of
Trees once more.`,
GOTO,
"Book1/358.js",
`go to 358`,
