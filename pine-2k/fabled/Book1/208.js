save("save/bookmark", "Book1/208.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Using your sorcerous powers you
breathe a cloud of greenish vapour
over the ratmen. Coughing and
gasping, they sink into an
enchanted slumber - all but King
Skabb. Standing on the altar, he
is able to keep his head above the
vapours.`,
GOTO,
"Book1/145.js",
`go to 145`,
