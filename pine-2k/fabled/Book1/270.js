save("save/bookmark", "Book1/270.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You make a swift inspection of the
casements, walls and furnishings,
searching for secret panels where
treasure might be concealed.`,
GOTO,
"Book1/extra_96.js",
`Make
a THIEVERY roll at a Difficulty of
12`,
`.`,
MARK
];
