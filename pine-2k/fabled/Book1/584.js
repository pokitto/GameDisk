save("save/bookmark", "Book1/584.js");
...
`
  ...
  'How can I come out to you? I
would drown in the sea - is that
what you plan?' you ask angrily.

  'Don't you know?' sighs one of
them. 'The kiss of the merfolk
gives the power to breathe the
waters to one of your kind for a
short time!'

  The others laugh mischieveously.
  `,
GOTO,
"Book1/254.js",
`Be kissed by the merfolk`,
`
  `,
GOTO,
"Book1/35.js",
`Return to the clifftop tor`,
MARK
];
