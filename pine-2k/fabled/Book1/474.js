save("save/bookmark", "Book1/474.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The Coldbleak Mountains look as
inhospitable and forbidding as
their name implies, their frozen
flanks climbing high into the icy
clouds.
  `,
GOTO,
"Book1/5.js",
...
GOTO,
"Book1/548.js",
`Head into the farmlands`,
`
  `,
GOTO,
"Book1/135.js",
`Go south to the Lake of the Sea
Dragon`,
MARK
];
