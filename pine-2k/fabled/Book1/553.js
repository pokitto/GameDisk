save("save/bookmark", "Book1/553.js");
...
`
  ...
  You convince her that you mean no
harm. The little girl tells you
that she was placing flowers at
the grave of her father, when a
horrible monster came for her.
Fortunately, she was able to run
away. She points to a large tomb
behind which the thing was hiding.

  You tell the girl to go home and
then you set out warily for the
tomb. Suddenly, a foul stench
fills your nostrils, and a figure
rises up out of the shadows!
Yellow eyes glow with feral
bloodlust, and the creature's
talons, encrusted with dried
blood, reach for you hungrily.`,
MARK,
`You've found the ghoul!
  `,
GOTO,
"Book1/617.js",
`Fight it`,
...
GOTO,
"Book1/303.js",
`Use some salt and iron filings`,
MARK
];
