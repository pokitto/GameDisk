save("save/bookmark", "Book1/310.js");
...
read on.
  ...
  The Stinking River has cut its
way through the high ground here.
On the edge of the chasm that
overlooks the river lies the
village of High Therys.

  The locals are behaving very
oddly. You watch the villagers lay
out a fine feast on the village
green. A pig is set roasting on a
spit, loaves of freshly baked
bread are piled beside bowls
overflowing with fruits, butter
and cheese. Lastly, the richest`,
MARK,
`merchants of the village bring
coffers full of silver which they
set beside the table. To your
amazement, instead of sitting down
to dine, the villagers then scurry
home and start closing the
