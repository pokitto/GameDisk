save("save/bookmark", "Book1/164.js");
...
`
  ...
  _ [If you're using a candle,
cross it off now --Ed] _

  The dank tunnels, running with
rivulets of foul water, take you
deeper into the unknown. You mark
the twisting passages with chalk
so that you can find your way
back.

  Shortly, you come out into a
large, rough-hewn cavern, wreathed
into shadows that dance and
flicker in the light you have
brought.

  A sound makes you start in
surprise.`,
GOTO,
"Book1/extra_40.js",
`Make a SCOUTING or a`,
MARK,
`THIEVERY roll against Difficulty
11`,
`. Successful SCOUTING/THIEVERY
roll Failed SCOUTING/THIEVERY roll`,
MARK
];
