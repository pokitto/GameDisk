save("save/bookmark", "Book1/extra_55.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
`Otherwise, the whirlwind guardian\n`,
`catches you, and buffets you\n`,
`against the stone walls until you\n`,
`are dead - your adventures are over\n`,
`unless you have a resurrection deal\n`,
`.\n`,
MARK
];

const saveData = file("player", 0);
