save("save/bookmark", "Book1/331.js");
...
read on.
  ...
  You fall into conversation with
Pyletes, a kindly old
scholar-priest of Molhern, the God
of Knowledge.

  'Many years ago, the * Book of
the Seven Sages * was stolen from
us,' he croaks. 'News suggests
that the scorpion men are in
possession of it. I need a young
adventurer like yourself to travel
to Scorpion Bight and return the
book to me. In return I can show
you how to improve the skill of`,
MARK,
`your choice.'

  If you take up the quest, gain
the codeword Artefact . Now`,
GOTO,
"Book1/10.js",
`turn
back to 10`,
