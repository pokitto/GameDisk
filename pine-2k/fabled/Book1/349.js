save("save/bookmark", "Book1/349.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are too fast to get caught, and
run off into the shadowy
backstreets of Caran Baru. Cursing
your luck, you consider your next
move.`,
GOTO,
"Book1/400.js",
`go to 400`,
