save("save/bookmark", "Book1/281.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Your tale of valour and derring-do
falls on an unappreciative
audience. The mer-folk slip
beneath the waves with snorts of
derision, leaving you alone on the
desolate beach. There is nothing
for you to do but return to the
clifftop tor.
  `,
GOTO,
"Book1/602.js",
