save("save/bookmark", "Book1/290.js");
...
`
  ...
  If you have the codeword Cutlass,`,
GOTO,
"Book1/403.js",
`
go to 403`,
`immediately. If not, but
you have the codeword Amcha,`,
GOTO,
"Book1/512.js",
`go to
512`,
`. Otherwise read on.
  ...
  The guildmaster, a tall gaunt
man, welcomes you.

  'The guild, in Golnir and Sokara,
is plagued by privateers on the
high seas. Amcha One-eye is the
worst of these lawless dogs - he
has cost us thousands of Shards!
Bring me the head of Amcha
One-eye, and I will reward you! He
and his cut-throat crew operate
from the Unnumbered Isles - now
called the Kingdom of the Reavers`,
MARK,
`because of the pirates who have
made their base there. The isles
lie to the south.'

  If you want to take up the quest,
note the codeword Amcha . When you
are ready,`,
GOTO,
"Book1/100.js",
`go to 100`,
