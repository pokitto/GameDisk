save("save/bookmark", "Book1/444.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You try to make a run for it. and
add your Rank. Subtract 1 from the
total if you have a poor crew. Add
1 if you have a good crew or add 2
if you have an excellent crew.`,
GOTO,
"Book1/51.js",
`The
galley overtakes you`,
GOTO,
"Book1/402.js",
`You outrun
them`,
