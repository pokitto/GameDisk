save("save/bookmark", "Book1/88.js");
...
investments have done, . Add 1 to
the dice roll if you are an
initiate of the Three Fortunes.
Also add 1 if you have the
codeword _ Almanac _ , add 2 if
you have the codeword _ Brush _ ,
and add 3 if you have the codeword
_ Eldritch _ . Lose entire sum
invested Loss of 50% Loss of 10%
Investment remains unchanged
Profit of 10% Profit of 50% Double
initial investment
...
`go to 104`,
`, where you can
withdraw or leave the sum written
in the box there after adjusting
it according to the result rolled.`,
MARK
];
