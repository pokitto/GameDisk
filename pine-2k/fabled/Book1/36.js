save("save/bookmark", "Book1/36.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Soon you realize you are completely
lost in this strange, magical
forest. You wander around for
days, barely able to find enough
food and water. Lose 4 Stamina
points . If you still live, you
eventually stagger out of the
forest to the coast.`,
GOTO,
"Book1/128.js",
`go to 128`,
