save("save/bookmark", "Book1/479.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` They seem quite alarmed to see you
charge forward undaunted. As your
first blow lands solidly and you
hear a satisfying grunt of pain,
you know for a fact that these are
no ghosts that you are facing, but
people of flesh and blood. Fight
them one at a time: If you win,`,
GOTO,
"Book1/171.js",
`go
to 171`,
`. If you lose, you are
dead, unless you have a
resurrection deal .`,
MARK
];
