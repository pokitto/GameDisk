save("save/bookmark", "Book1/414.js");
...
`
  ...
  Haylie runs into her mother's
arms for a tearful reunion. Lynn,
the mother, gives you a suit of
and a (an ordinary weapon).

  'These have been in the family
for generations - it's all I have
to give,' she says.

  Fourze is hauled off to the local
magistrate for judgment - he will
probably be sold into slavery.

  Gain the codeword Attar and`,
GOTO,
"Book1/427.js",
`go to
427`,
