save("save/bookmark", "Book1/576.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You are up the Stinking River, near
its source - the Lake of the Sea
Dragon. From here, the yellow
waters rush down to the sea. The
smell of the bubbling,
sulphur-laden water is abominable.
  `,
GOTO,
"Book1/135.js",
`Go to the Lake of the Sea Dragon`,
`
  `,
GOTO,
"Book1/310.js",
