save("save/bookmark", "Book1/246.js");
...
stolen the * gold chain mail of
Tyrnai * for the Temple of Sig,`,
GOTO,
"Book1/467.js",
`go
to 467`,
`. If not, read on.
  ...
  The Temple of Tyrnai, the God of
Battle, Chaos and Strife, is built
like a small fortress in one
corner of the city, near the
barracks. Its heavy wooden gates
are flanked by iron statues of
bull-headed men wielding clubs.
The workmanship is uncannily
life-like. Inside, the god is
represented by a stone idol of a
jaguar-headed warrior. A beautiful
suit of gold chain mail adorns the
idol.`,
MARK,
`  `,
GOTO,
...
GOTO,
"Book1/33.js",
`Make resurrection arrangements`,
`
  `,
GOTO,
"Book1/305.js",
`Try to steal the chain mail`,
`
  `,
GOTO,
"Book1/400.js",
