save("save/bookmark", "Book1/533.js");
...
`
  ...
  The man takes the money, bites a
coin and spits. Satisfied he says,
'The Witches' Cauldron - that's
where you'll find him.'

  Later, you find the Witches'
Cauldron Tavern in a maze of
backstreets. Looking through a
window, you spot a man with a
velvet eyepatch sitting at a
table, eating a meal.
  `,
GOTO,
"Book1/589.js",
`Walk in and challenge him`,
`
  `,
GOTO,
"Book1/211.js",
`Ambush him when he leaves`,
MARK
];
