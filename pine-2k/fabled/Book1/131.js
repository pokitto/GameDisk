save("save/bookmark", "Book1/131.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` On the island is a community of sea
gypsies. They hail you, but then
they seem to recognize you. Rapid
activity takes place, and within
seconds a huge sail has been
raised, and the island scuds away
- it seems they would rather not
