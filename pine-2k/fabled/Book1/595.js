save("save/bookmark", "Book1/595.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You will have to sneak in around
the hall to get behind the king.
There are plenty of shadows to
hide in but it will not be easy.`,
GOTO,
"Book1/extra_237.js",
`
