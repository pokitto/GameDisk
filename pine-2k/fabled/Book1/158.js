save("save/bookmark", "Book1/158.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The Three Rings Tavern is a
comfortable inn near the city
centre. The tavern costs you 1
Shard a day. Each day you spend
...
GOTO,
"Book1/147.js",
`Pay 3 more Shards and buy some
drinks`,
`
  `,
GOTO,
