save("save/bookmark", "Book1/564.js");
...
`
  ...
  You tell the high priest about
the Curse of Tyrnai.

  'Ah, I see. Well, you have to
appease the god. You need a *
weapon (COMBAT +1) * , which you
can buy in most markets, or
acquire by some other means. Throw
the weapon into the holy waters at
the village of Blessed Springs,
and ask for his forgiveness.'

  Acquire the codeword Appease and`,
GOTO,
"Book1/100.js",
`
go to 100`,
