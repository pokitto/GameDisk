save("save/bookmark", "Book1/392.js");
...
`
  ...
  You pass your hands over the mad
beggar, mumbling a prayer to the
gods.

  The beggar cries out, 'A cloud
has been lifted from my mind! The
curse is dispelled! I remember
all!'

  His name, he tells you, is
Akradai, the Azure Prince of the
Horde of the Thundering Skies,
nomads of the steppes. 'I was
cursed with madness by Shazir of
the Ruby Citadel but now you have
cured me!' he says. 'I am forever
in your debt!'
`,
MARK,
`  He leaves, with a parting cry,
'Seek me on the steppes and I
shall reward you.'

  Gain the codeword Azure .`,
GOTO,
"Book1/10.js",
`go to
10`,
