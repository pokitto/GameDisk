save("save/bookmark", "Book1/385.js");
...
`
  ...
  The king is taken totally by
surprise, and you cut him down. He
falls dead at your feet.

  'Long live General Marlock,' you
mutter under your breath.

  You take the king's as proof of
your act. Note it on your
Adventure Sheet and get the
codeword Ark .

  Although you manage to talk your
way out of the stockade, the body
is discovered as you are heading
down the mountain path. Vengeful
soldiers set off in pursuit.
`,
MARK,
`  `,
GOTO,
"Book1/extra_134.js",
`Make a SCOUTING or a THIEVERY
roll (your choice) at Difficulty 9`,
`
. Successful SCOUTING or THIEVERY
roll Failed SCOUTING or THIEVERY
roll`,
MARK
];
