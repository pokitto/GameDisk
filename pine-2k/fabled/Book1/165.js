save("save/bookmark", "Book1/165.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` A Sokaran war galley hails you and
draws up alongside. 'We're coming
aboard for an inspection!' yells
the captain of the galley. His men
attempt to grapple your ship.
  `,
GOTO,
"Book1/552.js",
`Let them`,
