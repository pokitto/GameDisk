save("save/bookmark", "Book1/543.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Guildmaster Vernon is too busy to
see you. It seems he doesn't want
to know you, now that he doesn't
need you anymore. Such is life.`,
GOTO,
"Book1/405.js",
`go
to 405`,
