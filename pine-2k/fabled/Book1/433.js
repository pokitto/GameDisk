save("save/bookmark", "Book1/433.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You rush in, taking the ruffians by
surprise. A couple of good buffets
around the head, and they run off.
The scholar lies groaning on the
ground.
  `,
GOTO,
"Book1/172.js",
