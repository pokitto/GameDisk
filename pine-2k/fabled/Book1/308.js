save("save/bookmark", "Book1/308.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The ratmen beat you into
unconsciousness, and then toss you
down an underground sewer outlet.
You are washed up on the beaches
outside Yellowport, where you come
to. You have 1 Stamina point left
, and the ratmen have taken all
the items and money that you were
carrying. Cross them off your
Adventure Sheet. Groggily, you
