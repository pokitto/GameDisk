save("save/bookmark", "Book1/52.js");
...
you to try again when you fail a
SCOUTING roll. It is good for only
one reroll. When you use the
blessing, cross it off your
Adventure Sheet. You can only have
