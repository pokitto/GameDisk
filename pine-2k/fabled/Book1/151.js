save("save/bookmark", "Book1/151.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` Inside the cave, you find Damor the
Hermit, floating cross-legged in
the air. 'I told you never to come
back!' he shouts angrily. He waves
his hand, and you are teleported
back down to the bottom of the
mountain before you can say a
word.`,
GOTO,
"Book1/244.js",
`go to 244`,
