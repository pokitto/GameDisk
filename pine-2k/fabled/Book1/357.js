save("save/bookmark", "Book1/357.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The moon begins to rise, making the
ghosts seem to glow. They sit
hunched over their feast like
vultures, occasionally stirring
their hands in the pile of silver
coins and tittering eerily.
  `,
GOTO,
"Book1/23.js",
`Confront them`,
...
GOTO,
"Book1/541.js",
`Stay hidden and follow when they
leave`,
MARK
];
