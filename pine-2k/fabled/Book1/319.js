save("save/bookmark", "Book1/319.js");
...
`
  ...
  You give the * willow staff * to
the Oak Druid of the City of
Trees. Cross the off your
Adventure Sheet.

  'Ah, thank you,' the druid
intones, going on, 'a willow
staff, eh? I see.'

  As a reward, the druid lets you
train with the City of Trees' best
hunters and trackers. Gain 1 Rank
, and . The result is the number
...
`,
MARK,
`  When you are ready, you leave the
City of Trees and return to the
Trading Post.`,
GOTO,
"Book1/195.js",
`go to 195`,
