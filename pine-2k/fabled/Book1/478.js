save("save/bookmark", "Book1/478.js");
...
`
  ...
  Resurrection costs 200 Shards if
you are an initiate, 600 Shards if
not. It is the last word in
insurance. Once you have arranged
for resurrection you need not fear
death, as you will be magically
restored to life here at the
temple.

  To arrange resurrection, pay the
fee and write '`,
GOTO,
"Book1/350.js",
`go to 350`,
`' in the
Resurrection box on your Adventure
Sheet. If you are later killed,
turn to * 350 * in this book. You
can have only one resurrection
arranged at any one time. If you
arrange resurrection later at a
different temple, the original one`,
MARK,
`is cancelled - cross it off your
Adventure Sheet. You will not get
a refund!
