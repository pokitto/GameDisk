save("save/bookmark", "Book1/304.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` He spots you before you can get the
jump on him. 'Stinking assassin!'
he yells, drawing his sword. You
must fight him. If you win,`,
GOTO,
"Book1/92.js",
`go to
92`,
`. If you lose, he kills you,
and your adventuring days are
