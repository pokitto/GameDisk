save("save/bookmark", "Book1/510.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The village of Blessed Springs,
nestling at the foot of a tall
hill, has grown up around the holy
waters, a special spring said to
have healing powers. It has been
fenced off by the villagers, and a
priesthood appointed to supervise
the supplicants who come to bathe,
or drink of the spring's waters.
There is no market, but an
alchemist has set up shop here.
  `,
GOTO,
"Book1/450.js",
`Visit the Holy Waters`,
`
  `,
GOTO,
"Book1/342.js",
`Visit the alchemist's shop`,
`
  `,
GOTO,
"Book1/483.js",
`Visit the Blessed Ale Tavern`,
`
  `,
GOTO,
"Book1/398.js",
...
GOTO,
"Book1/466.js",
`Head north towards Fort Brilon`,
`
  `,
GOTO,
"Book1/87.js",
`South towards Venefax`,
`
  `,
GOTO,
"Book1/278.js",
