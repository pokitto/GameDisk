save("save/bookmark", "Book1/56.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` A strange-looking craft is bobbing
in the water. It is shaped like a
cone, floating on its base, and as
you draw nearer, you realise it is
made entirely of metal! Its sail,
a huge piece of cloth, seems to
have collapsed and is spread out
around it, on the surface of the
sea. Great blue and white letters,
in some foreign script, are
painted on its side. You notice an
opening on one side.
  `,
GOTO,
"Book1/496.js",
