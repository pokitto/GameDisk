save("save/bookmark", "Book1/227.js");
...
`
  ...
  Cross off 5 Shards . The mad
beggar takes the money and
swallows the lot in one gulp. 'A
gourmet meal!' he babbles.

  If you want to bless him,`,
GOTO,
"Book1/632.js",
`go to
632`,
`. If not, he wanders off
ranting and you head back to the
city centre,`,
GOTO,
"Book1/10.js",
`go to 10`,
