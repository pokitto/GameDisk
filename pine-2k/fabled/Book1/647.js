save("save/bookmark", "Book1/647.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` As you reach for the back of the
golem's head, it turns and grabs
your arm, yanking you to the
ground. Then it swings its club at
your head.
  `,
GOTO,
"Book1/349.js",
