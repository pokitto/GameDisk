save("save/bookmark", "Book1/337.js");
...
read on.
  ...
  The crew have been using a net to
catch fish. This time they have
caught a sea centaur, a
strange-looking creature, with a
top half like a man, and a bottom
half like a sea horse. It
struggles feebly, clutching at the
net with webbed fingers, trying to
saw it apart with a long, serrated
dagger made of some sea shell.

  'We'll have to kill it, Cap'n -
they're terrible bad luck to have
on board,' says the first mate.`,
MARK,
`
  One of the sailors is already
readying his cutlass.
  `,
GOTO,
"Book1/522.js",
`Give the order to kill it`,
`
  `,
GOTO,
"Book1/604.js",
