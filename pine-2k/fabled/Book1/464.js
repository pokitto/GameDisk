save("save/bookmark", "Book1/464.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The ship, already crippled by a
storm, and with only half its
crew, is easy meat for your hardy
men. The strangely dressed
foreigners surrender without much
of a fight. You get as booty, and
1 Cargo Unit of spices , if you
have the room to take it. Now`,
GOTO,
"Book1/559.js",
`go
to 559`,
