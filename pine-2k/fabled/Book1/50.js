save("save/bookmark", "Book1/50.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The new provost marshal of
Yellowport is Royzer - he used to
be Marloes Marlock's second in
command. Since the assassination
of the old provost, Royzer has
ruled the city with an iron hand -
patrols are frequent and spies are
everywhere. You will have to be
careful not to get yourself
recognised.`,
GOTO,
"Book1/10.js",
`Turn back to 10`,
