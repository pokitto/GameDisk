save("save/bookmark", "Book1/225.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` You find a cave, with piles of
human bones outside it. However,
it is quite empty without signs of
habitation - the beast that lived
here is dead or departed. You make
your way back down to Blessed
Springs.`,
GOTO,
"Book1/510.js",
`go to 510`,
