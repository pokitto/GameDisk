save("save/bookmark", "Book1/195.js");
...
`
  ...
  Gain the codeword Aspen if you do
not already have it.

  The Trading Post is a small
village, set up here by
enterprising settlers from the
mainland. Its main export appears
to be furs from the forest.

  The Mayor, a fat genial fellow,
who greets you personally, insists
that one day the Trading Post will
be a thriving town. There is not a
lot here yet, however: a small
market, a quay, the settler's
houses, and a shrine to Lacuna the
Huntress, goddess of nature.
  `,
GOTO,
"Book1/544.js",
`Visit the shrine to Lacuna`,
MARK,
`  `,
GOTO,
"Book1/452.js",
...
GOTO,
"Book1/181.js",
`Visit the Green Man Inn`,
`
  `,
GOTO,
"Book1/11.js",
`Climb the hill that overlooks
the town`,
`
  `,
GOTO,
"Book1/257.js",
`Go inland, into the Old Forest`,
MARK
];
