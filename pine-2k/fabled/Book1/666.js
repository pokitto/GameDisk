save("save/bookmark", "Book1/666.js");
...
`
  ...
  A trader from the far north tells
a story about a great wizard,
Targdaz the Magnificent, who was
tricked by a shaman of the Horde
of the Thousand Winds on the Great
Steppes.

  'He imprisoned Targdaz inside a
giant ruby, and proceeded to loot
Targdaz's tower. But in his
stupidity, he opened the great
wizard's Casket of Imponderables,
and unleashed a terrible storm
that swept across the steppes,
scattering many of the tribes far
and wide. The shaman was killed,
of course, but as far as anyone
knows, Targdaz is still trapped in`,
MARK,
`the ruby, waiting patiently for
release - perhaps for another
hundred years, who knows? One
thing's for certain - it won't be
...
GOTO,
"Book1/47.js",
`West in the Forest of Larun`,
`
  `,
GOTO,
"Book1/135.js",
`East to the lake and Cadmium`,
MARK
];
