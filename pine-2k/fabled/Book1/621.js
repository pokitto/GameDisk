save("save/bookmark", "Book1/621.js");

const MARK = 0;
const GOTO = 1;
const text = [
MARK,
` The coast road between Yellowport
and Venefax is wellmaintained and
you make good time. You pass a few
army patrols but they leave you
alone.
  `,
GOTO,
"Book1/510.js",
`Travel to Blessed Springs`,
`
  `,
GOTO,
"Book1/427.js",
