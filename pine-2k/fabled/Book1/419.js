save("save/bookmark", "Book1/419.js");
...
`
  ...
  The trail of gruesome murders,
and tales of terror leads you to
an old cemetery in a near-deserted
part of the old quarter. It is
early morning, a few hours before
dawn, so you haven't much time
before the ghoul goes into hiding.

  At the gates of the cemetery, you
find a small girl, hunched over,
sobbing. When she sees you, she
backs away, terrified.

  `,
GOTO,
"Book1/extra_158.js",
`Make a CHARISMA roll at a
difficulty of 10`,
`.`,
MARK
];
